...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (tabUnivScore) tabUnivScore.addEventListener("click", () => {
    switchTabTo(tabUnivScore, viewUnivScore);
    if (typeof window.renderUnivScoreTab === 'function') window.renderUnivScoreTab();
  });
  ...
  const universityData = {
    ...
    "명지대학교": {
      ...
      "인문대학 (서울캠퍼스)": ["인문콘텐츠학부(국어국문학전공)", "인문콘텐츠학부(영어영문학전공)", "인문콘텐츠학부(미술사·역사학전공)", "인문콘텐츠학부(문헌정보학전공)", "아시아·중동어문학부(중어중문학전공)", "아시아·중동어문학부(일어일문학전공)", "아시아·중동어문학부(아랍지역학전공)", "문예창작학과", "인문대학[광역]"],

      "사회과학대학 (서울캠퍼스)": ["공공인재학부(행정학전공)", "공공인재학부(정치외교학전공)", "경상·통계학부(경제학전공)", "경상·통계학부(국제통상학전공)", "경상·통계학부(응용통계학전공)", "법학과", "사회과학대학[광역]"],

      "경영대학 (서울캠퍼스)": ["경영학부(경영학전공)", "AI경영정보학과", "경영대학[광역]"],

      "미디어·휴먼라이프대학 (서울캠퍼스)": ["디지털미디어학부", "청소년지도·아동학부(청소년지도학전공)", "청소년지도·아동학부(아동학전공)", "미디어·휴먼라이프대학[광역]"],

      "인공지능·소프트웨어융합대학 (서울캠퍼스)": ["융합소프트웨어학부(응용소프트웨어전공)", "융합소프트웨어학부(데이터사이언스전공)", "융합소프트웨어학부(인공지능전공)", "디지털콘텐츠디자인학과", "인공지능·소프트웨어융합대학[광역]"],

      "아너칼리지 (서울캠퍼스)": ["자율전공학부(인문)"],

      "미래융합대학 (서울캠퍼스)": ["미래전략학부(부동산학전공)", "미래전략학부(법무행정학전공)", "미래전략학부(융합경영학전공)", "미래전략학부(회계세무학전공)", "융합인재학부(사회복지학전공)", "융합인재학부(심리치료학전공)", "융합인재학부(멀티디자인전공)"],

      "화학·생명과학대학 (용인캠퍼스)": ["화학·에너지융합학부(화학나노학전공)", "화학·에너지융합학부(융합에너지학전공)", "융합바이오학부(식품영양학전공)", "융합바이오학부(시스템생명과학전공)", "화학·생명과학대학[광역]"],

      "스마트시스템공과대학 (용인캠퍼스)": ["기계시스템공학부(기계공학전공)", "기계시스템공학부(로봇공학전공)", "스마트인프라공학부(건설환경공학전공)", "스마트인프라공학부(환경시스템공학전공)", "스마트인프라공학부(스마트모빌리티공학전공)", "화공신소재공학부(화학공학전공)", "화공신소재공학부(신소재공학전공)", "스마트시스템공과대학[광역]"],

      "반도체·ICT대학 (용인캠퍼스)": ["반도체공학부", "전기전자공학부(전기정보공학전공)", "전기전자공학부(전자공학전공)", "컴퓨터AI응용공학부(AI컴퓨터공학전공)", "컴퓨터AI응용공학부(AI응용시스템전공)", "산업경영공학과", "반도체·ICT대학[광역]"],

      "스포츠·예술대학 (용인캠퍼스)": ["디자인학부(비주얼커뮤니케이션디자인전공)", "디자인학부(인더스트리얼디자인전공)", "디자인학부(영상애니메이션디자인전공)", "디자인학부(패션디자인전공)", "스포츠학부(체육학전공)", "스포츠학부(스포츠산업학전공)", "예술학부(아트앤멀티미디어음악전공)", "예술학부(영화전공)", "예술학부(뮤지컬공연전공)", "스포츠·예술대학[광역]"],

      "건축대학 (용인캠퍼스)": ["건축학부(건축학전공)", "건축학부(전통건축학전공)", "공간디자인학과", "건축대학[광역]"],

      "아너칼리지 (용인캠퍼스)": ["자율전공학부(자연)"]

    },

    "상명대학교(서울)": {

      "인문사회과학대학": ["인문콘텐츠학부(역사콘텐츠전공)", "인문콘텐츠학부(지적재산권전공)", "인문콘텐츠학부(문헌정보학전공)", "인문콘텐츠학부(한일문화콘텐츠전공)", "공간환경학부", "행정학부", "가족복지학과", "국가안보학과", "경제금융학부", "글로벌경영학과", "융합경영학과"],

      "사범대학": ["국어교육과", "영어교육과", "교육학과", "수학교육과"],

      "경영대학": ["경영학부"],

      "ICT융합대학": ["지능·데이터융합학부(휴먼AI공학전공)", "지능·데이터융합학부(데이터과학전공)", "SW융합학부(컴퓨터과학전공)", "SW융합학부(전기공학전공)", "SW융합학부(게임전공)", "SW융합학부(애니메이션전공)", "생명화학공학부(생명공학전공)", "생명화학공학부(화학에너지공학전공)", "생명화학공학부(화공신소재전공)", "식품영양학전공", "의류학과"],

      "예체능대학": ["스포츠무용학부(스포츠건강관리전공)", "스포츠무용학부(무용예술전공)", "미술학부(조형예술전공)", "미술학부(생활예술전공)", "음악학부"],

      "자유전공학부": ["자유전공(인문계열)", "자유전공(이공계열)", "자유전공(예체능계열)"]
    ...
    "\ud55c\uc591\ub300\ud559\uad50 ERICA": {
      "공학대학": ["건축학부", "토목환경공학과", "교통·물류공학과", "전자공학부", "배터리·재료화학공학과", "기계공학과", "산업경영공학과", "로봇공학과", "에너지·생명공학과", "해양융합공학과", "융합시스템공학과", "스마트융합공학부"],
      "소프트웨어융합대학": ["컴퓨터학부", "ICT융합학부", "인공지능학과", "수학데이터과학과"],
      "첨단융합대학": ["차세대반도체융합공학부", "바이오·제약융합학부", "방위정보융합공학부"],
      "약학대학": ["약학과"],
      "글로벌문화통상대학": ["글로벌문화통상학부"],
      "커뮤니케이션&컬처대학": ["광고홍보학과", "미디어학과", "문화인류학과", "문화콘텐츠학과"],
      "경상대학": ["경제학부", "회계·세무학과", "경영학부", "보험계리학과"],
      "디자인대학": ["주얼리·패션디자인학과", "커뮤니케이션디자인학과", "비디오디자인학과", "융합디자인학부", "산업디자인학과"],
      "예체능대학": ["스포츠과학부", "무용예술학과", "응용음악학과"],
      "LIONS칼리지": ["LIONS자유전공학부"]

    },

    "\uace0\ub824\ub300\ud559\uad50(\uc138\uc885)": {
      "과학기술대학": ["응용수리과학부", "디스플레이·반도체물리학부", "신소재화학과", "컴퓨터소프트웨어학과", "전자및정보공학과", "생명공학과", "식품생명공학과", "환경시스템공학과", "전자·기계융합공학과", "미래모빌리티학과", "지능형반도체공학과", "인공지능사이버보안학과", "자유전공학부(과학기술)"],
      "공공정책대학": ["정부행정학부", "공공사회·통일외교학부", "경제통계학부", "빅데이터사이언스학부", "자유전공학부(공공정책)"],
...
\u25a0 3\ub300 \uc11c\ub958\ud3c9\uac00 \uc694\uc18c (\ube44\uc728 \ubbf8\uc9c0\uc815 \u2014 \uc815\uc131\uc801 \uc885\ud569\ud3c9\uac00)
1. \ud559\uc5c5\uc5ed\ub7c9: \uad50\uacfc \ubc0f \ud559\uc5c5 \ud65c\ub3d9\uc758 \uc6b0\uc218\ud55c \uc131\ucde8 + \uc9c0\uc2dd\uc758 \uae4a\uc774\u00b7\ud65c\uc6a9\u00b7\uc131\uc7a5 (\uc218\uac15\uc790\uc218\u00b7\uc6d0\uc810\uc218\u00b7\ud3c9\uade0\u00b7\ud45c\uc900\ud3b8\ucc28 \uc815\uc131 \ud574\uc11d, \uc138\ud2b9 \ub0b4 \ud559\uc2b5\ud65c\ub3d9\u00b7\uacfc\uc81c\uc218\ud589, \ucc3d\uccb4 \ub0b4 \ud559\uc5c5\ud0d0\uad6c)
2. \ud559\uc5c5\ud0dc\ub3c4: \uc790\uae30\uc8fc\ub3c4\uc801 \ud559\uc2b5 + \ud0d0\uad6c \uc758\uc9c0\u00b7\ud638\uae30\uc2ec\u00b7\ub3c4\uc804\uc801 \ud0dc\ub3c4 + \ubc30\uc6c0 \uc5f4\uc758 + \uad50\uc721\uc790\uc6d0 \uc801\uadf9 \ud65c\uc6a9 + \uc9c4\ub85c \ud0d0\uc0c9 \ub178\ub825 + \uc218\uc5c5 \ucc38\uc5ec\ub3c4
3. \ud559\uc5c5 \uc678 \uc18c\uc591: \ubc14\ub978 \uc778\uc131 + \ub9ac\ub354\uc2ed + \uacf5\ub3d9\uccb4 \uc758\uc2dd + \ubc30\ub824\uc2ec + \uc5ed\uacbd \uadf9\ubcf5 + \ud3ed\ub113\uc740 \uc2dc\uc57c (\ucc3d\uccb4\u00b7\ud589\ub3d9\ud2b9\uc131\u00b7\ucd9c\uacb0 \uadfc\uac70)

\u25a0 \ud3c9\uac00 \uae30\uc900 \uccb4\ud06c\ub9ac\uc2a4\ud2b8
   [\ud559\uc5c5\uc5ed\ub7c9] \uad50\uacfc \uc131\ucde8\uac00 \uace0\ub974\uac8c \uc6b0\uc218\ud55c\uac00? / \uae4a\uc774 \uc788\ub294 \uc774\ud574\ub97c \uac16\ucd94\uc5c8\ub294\uac00? / \uc9c0\uc2dd\uc744 \ud65c\uc6a9\ud55c \uacbd\ud5d8\uc774 \uc788\ub294\uac00?
              \uc131\ucde8\ub97c \uc810\uac80\ud558\uace0 \ub354 \ud544\uc694\ud55c \uacf5\ubd80\ub97c \uace0\ubbfc\ud558\ub294\uac00? / \uc758\ubbf8 \uc788\ub294 \ud559\uc2b5\uacbd\ud5d8\uc740? / \ub178\ub825\uc73c\ub85c \uc131\uc7a5\ud55c \ubaa8\uc2b5\uc740?
   [\ud559\uc5c5\ud0dc\ub3c4] \uc9c0\uc2dd\uc744 \uc313\ub294 \uacfc\uc815\uc774 \uc5b4\ub5a0\ud55c\uac00? / \uc801\uadf9\u00b7\uc9c0\uc18d\uc801\uc73c\ub85c \ub178\ub825\ud558\ub294\uac00? / \uad50\uc721\uc790\uc6d0\uc744 \uc801\uadf9 \ud65c\uc6a9\ud558\ub294\uac00?
              \ud638\uae30\uc2ec\uacfc \ub3c4\uc804\uc801 \ud0dc\ub3c4\uac00 \ub098\ud0c0\ub098\ub294\uac00? / \uc790\uae30\uc8fc\ub3c4\uc801\uc73c\ub85c \ud559\uc2b5\ud558\ub294\uac00? / \uc9c4\ub85c \ud0d0\uc0c9\uc774 \uc801\uadf9\uc801\uc778\uac00?
   [\ud559\uc5c5 \uc678 \uc18c\uc591] \ubc14\ub978 \uc778\uc131\uc744 \uac16\ucd94\ub824 \ub178\ub825\ud558\ub294\uac00? / \ub9ac\ub354\uc2ed\uc744 \ubc1c\ud718\ud55c \uacbd\ud5d8\uc774 \uc788\ub294\uac00? / \uacf5\ub3d9\uccb4 \uc758\uc2dd\uc744 \uc9c0\ub2c8\ub294\uac00?
                  \ud3ed\ub113\uc740 \uc2dc\uc57c\ub97c \uac16\ucd94\ub824 \ub178\ub825\ud558\ub294\uac00? / \uc5b4\ub824\uc6c0\uc744 \uadf9\ubcf5\ud55c \uacbd\ud5d8\uc774 \uc788\ub294\uac00? / \uc0ac\ud68c\uc801 \uc57d\uc790\ub97c \ubc30\ub824\ud558\ub294\uac00?

\u25a0 \uad50\uacfc \uc131\uc801 \uc815\uc131\ud3c9\uac00 \ud575\uc2ec
   - \uc218\uac15\uc790 \uc218, \uc6d0\uc810\uc218, \ud3c9\uade0, \ud45c\uc900\ud3b8\ucc28\ub97c \uc885\ud569\uc801\uc73c\ub85c \uace0\ub824\ud55c \uc815\uc131\uc801 \ud574\uc11d (\uc815\ub7c9 \uacf5\uc2dd \uc5c6\uc74c)
   - \ud559\uad50 \uad50\uc721\ud658\uacbd\u00b7\uac1c\uc124 \uacfc\ubaa9 \ud604\ud669 \ub0b4 \ub178\ub825 \uc911\uc2ec \ud3c9\uac00
   - \ud575\uc2ec \uad8c\uc7a5\uacfc\ubaa9\u00b7\uad8c\uc7a5\uacfc\ubaa9 \uc774\uc218 \uc5ec\ubd80 \uc911\uc694 (\ubaa8\uc9d1\ub2e8\uc704\ubcc4 \uc0c1\uc774)
   - \uc18c\uc218 \uc774\uc218\u00b7\uace0\ub09c\ub3c4 \uacfc\ubaa9\uc758 \ub0ae\uc740 \ub4f1\uae09\ub3c4 \ubd88\uc774\uc775 \uc5c6\uc74c
   - 2022 \uac1c\uc815\uad50\uc721\uacfc\uc815(\ud604 1\u00b72\ud559\ub144): 5\ub4f1\uae09 \uccb4\uacc4(A~E) \uc815\uc131 \ud574\uc11d

\u25a0 \ub2e4\ub2e8\uacc4 \ud3c9\uac00 \ud504\ub85c\uc138\uc2a4
   \u2460 \uc804\uc784\uc0ac\uc815\uad00 1\ucc28 \ub3c5\ub9bd\ud3c9\uac00 \u2192 \u2461 \uc804\uc784\uc0ac\uc815\uad00 2\ucc28 \ub3c5\ub9bd\ud3c9\uac00 \u2192 \u2462 \uac80\ud1a0\u00b7\uc870\uc815
   \u2192 \u2463 \uc704\ucd09\uc0ac\uc815\uad00(\uad50\uc218\uc9c4) \ud3c9\uac00 \u2192 \u2464 \ucd5c\uc885 \ud3c9\uac00\uc704\uc6d0\ud68c
   - \uc804\uc784\uc785\ud559\uc0ac\uc815\uad00 28\uba85 + \uc704\ucd09\uc785\ud559\uc0ac\uc815\uad00 \uc57d 110\uba85

\u25a0 \uc804\ud615\ubcc4 \ube44\uc728: \uc9c0\uc5ed\uade0\ud615(\uc11c\ub958 70%+\uba74\uc811 30%) / \uc77c\ubc18(\uc11c\ub958 50%+\uba74\uc811\u00b7\uad6c\uc220 50%)
`,
      competencies: {
        academic: "\ud559\uc5c5\uc5ed\ub7c9(\uad50\uacfc \uc131\ucde8\ub3c4 \uc815\uc131 \ud574\uc11d\u00b7\uc218\uac15\uc778\uc6d0\u00b7\uc131\uc801 \ucd94\uc774\u00b7\uc9c0\uc2dd \uae4a\uc774\u00b7\ud65c\uc6a9\u00b7\uc131\uc7a5) + \ud559\uc5c5\ud0dc\ub3c4(\uc790\uae30\uc8fc\ub3c4\ud559\uc2b5\u00b7\ud0d0\uad6c\uc758\uc9c0\u00b7\ud638\uae30\uc2ec\u00b7\ubc30\uc6c0 \uc5f4\uc758)",
        career: "\ud559\uc5c5\ud0dc\ub3c4(\uc9c4\ub85c \ud0d0\uc0c9 \ub178\ub825\u00b7\ub3c4\uc804\uc801 \uacfc\ubaa9 \uc120\ud0dd) + \ud559\uc5c5\uc5ed\ub7c9(\uc804\uacf5\uad00\ub828 \uc138\ud2b9\u00b7\ud0d0\uad6c\ud65c\ub3d9\u00b7\uad50\uacfc\uc774\uc218\ud604\ud669)",
        community: "\ud559\uc5c5 \uc678 \uc18c\uc591(\ubc14\ub978 \uc778\uc131\u00b7\ub9ac\ub354\uc2ed\u00b7\ud611\uc5c5\u00b7\uacf5\ub3d9\uccb4\uc758\uc2dd\u00b7\ubc30\ub824\uc2ec\u00b7\uc131\uc2e4\uc131\u00b7\ucd9c\uacb0\u00b7\ubd09\uc0ac\ud65c\ub3d9\u00b7\ud589\ub3d9\ud2b9\uc131)"
      },
      weights: { academic: 0.34, career: 0.33, community: 0.33 } // \uc815\uc131\ud3c9\uac00 (\uade0\ub4f1, \ube44\uc728 \ubbf8\uc9c0\uc815)
    },
    "연세대학교": {
      factors: `
[연세대학교 2027학년도 학생부종합전형 서류평가 기준 — 공식 안내서 반영]

■ 서류평가 구조
   종합평가Ⅰ (70%) = 학업역량 + 진로역량 (두 역량 통합 평가)
   종합평가Ⅱ (30%) = 공동체역량

■ 학업역량 [종합평가Ⅰ]
   ✦ 학업성취도: 교과목 성취수준 및 학업발전 정도 (학년별 변화 추이, 수강인원 맥락 고려)
   ✦ 학업태도: 자기주도 학습의지, 수업 참여 열정, 교과 내외 학업 관심
   ✦ 탐구력: 교과·탐구활동을 통해 지식을 확장하고자 하는 노력

■ 진로역량 [종합평가Ⅰ]
   ✦ 교과이수 노력: 전공 관련 권장과목 선택, 이수 위계 준수, 도전적 과목 선택 (긍정 평가)
   ✦ 전공관련 성취도: 진로선택·일반선택·전문교과에서 전공 관련 교과 성취
   ✦ 진로탐색 경험: 연속성·일관성 있는 진로 탐색 과정 (결과보다 탐구 과정 중시)

■ 공동체역량 [종합평가Ⅱ — 30%]
   ✦ 협업과 소통: 공동 과제 수행, 동료 존중, 다양한 의견 조율
   ✦ 나눔과 배려: 학교생활 속 나눔 실천, 다양성 존중
   ✦ 성실성·규칙준수: 출결 상황, 학교생활 규칙 준수
   ✦ 리더십: 공동체에서의 책임 있는 역할 수행

■ 평가 방식
   - 블라인드 평가: 성명·학교명·주소 등 개인정보 비공개
   - 복수 평가위원 독립 정성 종합평가
   - 비교과 증빙서류 제출 불가 (학생부 기록 내용만 반영)

■ 계열별 권장 과목
   수학/AI/컴퓨터: 미적분·기하·AI수학 | 물리/기계: 물리Ⅰ·Ⅱ·화학
   생명/의약: 화학·생명과학Ⅰ·Ⅱ | 경영/경제: 통계·수학 | 인문/사회: 독서·논리·토론

■ 전형별 선발: 활동우수형(1단계 4배수→면접40%) / 국제형 국내고(1단계 5배수) / 기회균형·국제인재(3배수)
`,
      competencies: {
        academic: "학업역량(학업성취도·성적 추이·학업태도·탐구력) — 종합평가Ⅰ(70%)",
        career: "진로역량(전공관련 교과이수·성취도·진로탐색 과정) — 종합평가Ⅰ(70%)",
        community: "공동체역량(협업·소통·나눔·배려·성실성·리더십) — 종합평가Ⅱ(30%)"
      },
      weights: { academic: 0.35, career: 0.35, community: 0.30 } // 종합Ⅰ(학+진)70% / 종합Ⅱ(공)30%
    },    "고려대학교": {
      factors: `
[고려대학교 2027학년도 수시 학생부종합전형 평가 기준 — 모집요강 반영]

■ 전형별 선발 구조
   학업우수전형: 서류 100% 일괄합산 (수능최저有) — 학업역량50%·자기계발역량30%·공동체역량20%
   계열적합전형: 서류 100% (5배수) → 1단계60%+면접40% (수능최저無) — 학업역량40%·자기계발역량40%·공동체역량20%
   학교추천전형: 교과90%+서류10% 일괄합산 (수능최저有) — 서류: 교과이수충실도70%+공동체역량30%

■ 서류 역량 및 평가 항목

   ◆ 학업역량 [학업우수 50% / 계열적합 40%]
   ✦ 학업성취도: 전반적인 교과목 성취수준 (석차등급·원점수·수강자수 맥락 고려한 정성 해석)
   ✦ 학업의지와 노력: 학업을 지속적으로 수행하고자 하는 열의와 자기주도적 노력
   ✦ 탐구력: 교과 내 심화·확장 탐구, 스스로 질문하고 답을 찾아가는 지적 호기심
   ✦ 교과이수 충실도: (학교추천) 다양한 교과 이수, 전공 관련 교과 충실 이수 여부

   ◆ 자기계발역량 [학업우수 30% / 계열적합 40%]
   ✦ 계열 관련 역량: 지원 계열·모집단위 관련 탐색 노력과 준비 정도 (결과보다 과정 중시)
...
■ 학생부 평가 근거
   학업역량: 교과이수현황 · 세부능력및특기사항(교과학습·과제수행) · 진로활동 · 행동특성및종합의견
   자기계발역량: 교과이수현황(계열관련 과목) · 세부능력및특기사항(탐구·발표·연구) · 동아리활동 · 자율활동
   공동체역량: 창의적체험활동(봉사·동아리) · 행동특성및종합의견 · 출결현황

■ 블라인드 평가: 수험번호·이름·출신고교 비공개 (서류·면접·논술 전형 모두 적용)
■ 평가 방식: 복수 입학사정관 독립 정성 종합평가, 점수 차이 발생 시 추가 다단계 평가 절차
`,
      competencies: {
        academic: "학업역량(학업성취도·학업의지·탐구력) — 학업우수전형 50% / 계열적합전형 40%",
        career: "자기계발역량(계열관련 탐색·탐구력·주도성) — 학업우수전형 30% / 계열적합전형 40%",
        community: "공동체역량(규칙준수·나눔·배려·리더십·성실성) — 전형 공통 20%"
      },
      weights: { academic: 0.50, career: 0.30, community: 0.20 } // 학업우수전형 기준
    },    "\uc11c\uac15\ub300\ud559\uad50": {
      factors: `
...
`,
    ...
    "한국외국어대학교": {
      factors: `
[한국외국어대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 가이드북 반영]

■ 전형별 선발 구조
   면접형(478명): 서류100%(3배수) → 서류50%+면접50% / 수능최저 없음
   SW인재(34명): 서류100% 일괄합산 (컴퓨터공학부 서울만) / 수능최저 없음
   서류형(585명): 서류100% 일괄합산 / 수능최저 없음
   기회균형(183명): 서류100% 일괄합산 / 수능최저 없음

■ 서류평가 3대 역량 (전형별 비율 상이)
   면접형·SW인재: 학업역량30% + 진로역량50%(핵심) + 공동체역량20%
   서류형·기회균형: 학업역량50%(핵심) + 진로역량30% + 공동체역량20%

   ◆ 학업역량
   ✦ 학업성취도: 교과 성취 수준 (수강자수·원점수 맥락 정성 해석)
   ✦ 학업태도: 수업 참여, 자기주도 학습 의지와 배움에 대한 열의
   ✦ 탐구력: 교과 간 지식 전이(Transference) — 배운 개념을 다른 분야에 연결·적용
   ✦ 탁월성: 교과 간 지식 전이, 자기주도 심화 탐구 과정이 핵심 평가 지표

   ◆ 진로역량
   ✦ 전공 관련 교과 이수 노력·성취도: 계열(외국어·AI·국제통상 등) 관련 과목 선택과 성취
   ✦ 진로 탐색 일관성: 희망 분야에 대한 지속적·일관된 관심 흐름 (진로 변화도 과정 자체 중시)
   ✦ 자기주도 심화 탐구: 스스로 질문하고 교과 간 연결한 세특 기록의 질

   ◆ 공동체역량 [전 전형 공통 20%]
   ✦ 협업과 소통: 공동 활동에서 구체적 기여와 타인 존중
   ✦ 나눔과 배려·성실성·규칙준수: 출결·봉사활동·학교생활 전반
   ✦ 리더십: 단체 활동에서 갈등 해결·목표 달성 주도 경험

■ 학생부 평가 근거
   학업역량: 교과이수현황 · 세부능력및특기사항(교과학습·탐구) · 행동특성및종합의견
   진로역량: 세부능력및특기사항(전공관련 탐구·심화) · 교과이수현황 · 동아리 · 진로활동
   공동체역량: 창의적체험활동(동아리·봉사·자율) · 행동특성및종합의견 · 출결현황

■ 면접평가 (면접형 2단계) — 2027 변경
   진로개발역량 60%(진로탐색·실천능력·논리적사고·자기주도성) + 협력적소통역량 40%
   블라인드 면접 (교복·수험표 착용 금지) / 학생부 기반 개인맞춤 질문

■ 수능최저 (학교장추천·논술전형)
   서울 주요 모집단위: 2개 합 4이내 / 글로벌·일부 서울: 2개 합 6이내 / 한국사 반영 폐지(2027)
`,
      competencies: {
        academic: "학업역량(성취도·학업태도·탐구력·교과간 지식전이) — 면접형·SW인재 30% / 서류형·기회균형 50%",
        career: "진로역량(전공관련 이수·성취·진로탐색 일관성·심화탐구 진정성) — 면접형·SW인재 50%★ / 서류형 30%",
        community: "공동체역량(협업·소통·나눔·성실성·리더십) — 전 전형 공통 20%"
      },
      weights: { academic: 0.30, career: 0.50, community: 0.20 }
    },    "서울시립대학교": {
      factors: `
[서울시립대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 전형별 선발 구조
   학생부종합전형Ⅰ(면접형, 410명): 1단계(3배수) 서류100% → 2단계 서류50%+면접50% / 수능최저 없음
   학생부종합전형Ⅱ(서류형, 99명): 서류평가 100% 일괄합산 / 수능최저 없음 (2027 변경: 기존 수능최저 폐지)
   기회균형전형Ⅰ(132명) / 사회공헌·통합전형(46명): 면접형과 동일 구조

■ UOS 3대 역량 및 전형별 반영 비율
   ◆ 학업역량 [면접형·기회균형·사회공헌통합: 35% / 서류형: 30%]
   ✦ 고교기초학업능력: 3년간 성적 추이(상승세)·원점수·이수자 수 등 교육환경 종합 고려 (정성적 해석)
   ✦ 대학전공기초소양: 지원 전공 관련 교과목 이수 현황과 성취도 — 단순 등급이 아닌 전공적합 교과 이수 여부 중시

   ◆ 잠재역량 [면접형·기회균형·사회공헌통합: 40% / 서류형: 50%] ← 가장 변별력이 큰 항목
   ...
   ◆ 사회역량 [면접형·기회균형·사회공헌통합: 25% / 서류형: 20%]
   ✦ 공동체및시민윤리의식: 공적 윤리·공익 추구 태도 — 형식적 봉사 시간보다 활동 과정의 진정성 중시
   ✦ 협동학습능력: 공동체 내 주도적 협업, 타인에 대한 배려와 리더십

■ 2027학년도 주요 변경사항
   ✦ 서류형 수능최저 폐지: 2026까지 국·수·영·탐(1) 중 2개합5이내+한국사4이내 적용 → 2027 완전 폐지
   ✦ 면접형 모집인원 조정: 433명 → 410명 (23명 감소) / 서류형: 80명 → 99명 (19명 증가)
   ✦ 고교추천전형 정성평가 확대: 교과90%+정성10% → 교과80%+정성20% (정성 비중 2배)
   ✦ 논술전형 모집인원 증가: 76명 → 88명

■ 블라인드 평가 원칙
   ✦ 성명·수험번호·출신고교 등 신상정보 불식별 — 편견 요소(성별·출신지역·종교·가족환경) 기재 금지
   ✦ 학교별 교육여건(소재지·규모·개설과목 수) 차이 충분히 고려하여 정성적 평가

■ 면접평가 (면접형·기회균형·사회공헌통합)
   ✦ 블라인드 개인면접: 면접관 2인 대 지원자 1인, 약 12분, 모집단위별 진행
   ✦ 평가요소: 종합적 사고력·문제해결능력·의사소통능력·공적윤리의식·제출서류 진실성
   ✦ 면접 배점 비율: 학업역량35%+잠재역량40%+사회역량25%
`,
      competencies: {
        academic: "학업역량(고교기초학업능력+대학전공기초소양) — 면접형 35% / 서류형 30%",
        career: "잠재역량(다학제적전공수학열의+통합적문제해결역량) — 면접형 40% / 서류형 50%",
        community: "사회역량(공동체및시민윤리의식+협동학습능력) — 면접형 25% / 서류형 20%"
      },
...
`,
    ...
    "건국대학교": {
      factors: `
[건국대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 전형별 선발 구조
   KU자기추천(903명): 1단계(3배수) 서류100% → 2단계 1단계성적70%+면접30% / 수능최저 없음
   기회균형(정원내, 79명): 서류70%+교과정량30% 일괄합산 / 수능최저 없음
   KU지역균형(345명, 교과전형): 교과정량70%+교과정성30% / 수능최저 없음
   KU논술우수자(328명): 논술100% / 인문·통합 2개합5이내+한국사5이내, 자연·KU자유전공·수의예 3개합4이내+한국사5이내

■ KU종합평가시스템 — 역량별 반영 비율
   ◆ 학업역량 [학과(부)별: 30% / KU자유전공학부: 20%]
   ✦ 학업성취도: 교과 성취수준 및 학년별 성적 추이 — 교육환경(소재지·이수자수·개설과목) 종합 고려
   ✦ 학업태도: 자기주도적 학습 노력 및 수업 참여 태도
   ✦ 탐구력: 지적 호기심에서 출발한 탐구 활동과 그 성과 (KU자유전공학부는 성장역량으로 이동)

   ◆ 진로역량 [학과(부)별: 40% — 핵심 / KU자유전공학부: 미적용(성장역량으로 대체)]
   ✦ 전공관련교과이수노력: 전공(계열) 관련 선택·이수 과목 적절성 — 진로선택과목 이수 여부 중시
   ✦ 전공관련교과성취도: 진로선택과목 및 전공 관련 교과의 성취도
   ✦ 진로탐색활동: 교과·비교과에서 나타난 전공 탐색 경험의 깊이와 방향성

   ◆ 성장역량 [KU자유전공학부: 50% — 핵심]
   ✦ 자기주도성: 목표 설정 및 실행 계획의 자기주도적 추진 과정
   ✦ 창의적문제해결력: 논리적 사고와 새로운 시각으로 문제를 해결한 경험
   ✦ 경험의다양성: 융합적 소양과 다양한 교내 활동 경험
...
■ 2027학년도 주요 변경사항
   ✦ 컴퓨터공학부 분리: 인공지능학과(50명)+컴퓨터공학과(70명)로 신설, 융합과학기술원 → 융합생명과학대학 재편
   ✦ 연기우수자 전형방법 변경: 교과정량100%(20배수) → 실기100%(자유연기3분+특기실연1분)
   ✦ 연출우수자 전형 신설: 서류100%(10배수) → 실기100%(스토리구성 3시간), 영화예술학과
   ✦ 전형명 간소화: KU연기우수자→연기우수자, KU체육특기자→체육특기자

■ 평가 원칙 및 면접
   ✦ 블라인드 평가: 이름·수험번호·고교명 블라인드, 교복 착용 금지
   ✦ KU종합평가시스템: 7등급 척도(A+~D), 입학사정관 2인 독립평가 — 점수 차 초과 시 재평가
   ✦ 활동 결과보다 준비 과정·노력·활동 후 변화에 초점 (과정 중심 평가)
   ✦ 면접(KU자기추천): 개인면접 10분, 면접관 2인, 서류 기반 진위·인성·학교생활 충실성 평가
`,
      competencies: {
        academic: "학업역량(학업성취도+학업태도+탐구력) — 학과(부)별 30% / KU자유전공 20%",
        career: "진로역량(전공관련교과이수+성취도+진로탐색) — 학과(부)별 40% / KU자유전공 미적용",
        community: "공동체역량(협업·나눔·성실성·리더십) — 전 전형 공통 30%"
      },
      weights: { academic: 0.30, career: 0.40, community: 0.30 },
    },
    "동국대학교": {
      factors: `
[동국대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 전형별 선발 구조
   Do Dream(655명): 1단계(2.5/3/3.5배수) 서류100% → 2단계 서류70%+면접30% / 수능최저 없음
   불교추천인재(108명): 동일 구조 / 불교 관련 자격·추천 필수
   기회균형통합(132명): 동일 구조 / 사범·열린전공학부는 1단계 5배수
   학교장추천인재(409명, 교과): 교과70%+서류30% 일괄합산 / 수능최저 없음
   논술우수자(282명): 논술70%+교과20%+출결10% / 인문 2합5+한국사4, 자연 2합5+수학/과탐+한국사4, 약학 3합4+수학/과탐+한국사4

■ 서류평가 역량 구성
   ◆ 학업역량 [Do Dream·불교추천인재·기회균형: 30% / 학교장추천인재: 50%]
   ✦ 기초학업역량: 국어·수학·영어 중심 교과 종합 학업역량 — 학년별 성적 추이·교육환경 고려
   ✦ 학습의 주도성: 교과목 이수 노력·수업 참여 태도, 비교과 활동에서의 적극적 참여

   ◆ 전공적합성 [Do Dream·불교추천인재·기회균형: 50% — 핵심]
   ✦ 전공수학역량: 전공 관련 교과목 이수 과정 및 성취도 — 진로선택과목 이수 여부와 수준 중시
   ✦ 전공관심도및진로탐색노력: 진로탐색 활동의 과정·깊이, 학교생활 중 전공 관련 경험의 진정성

   ◆ 진로역량 [학교장추천인재: 30%] — 창의적체험활동 제외, 교과 관련 영역만 평가
   ✦ 탐구역량: 모집단위별 필요역량 관련 교과 이수 현황과 성취도
   ✦ 진로탐색노력: 진로선택과목 이수 노력, 교과 활동에서의 진로탐색 및 융합역량

   ◆ 인성 및 사회성 [전 전형 공통: 20%]
   ✦ 역할의 주도성: 다양한 영역에서 주도적 역할 수행 및 책임감
   ✦ 협업소통능력: 공동체 목표 달성을 위한 협력 과정, 공동체 내 소통하는 태도

■ 2027학년도 주요 변경사항
   ✦ Do Dream 모집인원 증가: 634명 → 655명 (+21명)
   ✦ 1단계 선발배수 하향: 2.5/3.5/4배수 → 2.5/3/3.5배수 (서류평가 통과 난이도 상승)
   ✦ 기회균형 사범·열린전공학부: 4배수 → 5배수 (완화)
   ✦ 학교장추천인재 -9명, 논술우수자 -11명, 기회균형통합 -4명
   ✦ 한국음악과·한국실용음악 선발분야 확대 (작곡/지휘 → 작곡/지휘/음악학·예술경영)

■ 평가 원칙 및 면접
   ✦ 블라인드 평가: 수험번호·성명·고교명 블라인드, 입학사정관 2인 독립평가 → 점수차 초과 시 재평가
   ✦ 점수 표준화: 평가위원별 점수 표준화 → 조정된 개별점수 평균을 반영총점으로 환산
   ✦ 면접(Do Dream·기회균형): 10분 개별면접, 전형취지적합성20%+전공적합성30%+발전가능성30%+인성20%
   ✦ 면접(불교추천인재): 불교대학 12분 / 불교대학 외 7분+5분(2회), 전형취지적합성30%(불교적 가치)+전공30%+발전20%+인성20%

■ 모집단위별 전공 관련 교과 영역 (2026학년도 기준 | 전공수학역량·진로역량 평가 참고)
   ◆ 불교대학
   - 불교학부: 역사, 윤리
   - 문화유산학과: 국어, 사회문화, 역사, 한문
   ◆ 문과대학
   - 국어국문·문예창작학부: 국어, 사회문화, 역사, 한문
   - 영어영문학부(영어문학전공): 국어, 영어, 사회문화
   - 영어영문학부(영어통번역학전공): 국어, 영어, 사회문화
   - 일본학과: 국어, 역사, 사회문화, 정치와법, 경제, 일본어
   - 중어중문학과: 국어, 역사, 중국어
   - 철학과: 국어, 윤리, 철학, 논리학
   - 사학과: 국어, 역사, 한문
   ◆ 이과대학
   ...
   - 법학과: 국어, 역사, 윤리, 정치와법
   ◆ 사회과학대학
   - 정치외교학전공: 역사, 사회문화, 정치와법, 경제, 윤리
   - 행정학전공: 사회문화, 정치와법, 경제
   - 북한학전공: 국어, 역사, 사회문화, 지리
   - 경제학과: 국어, 수학, 영어, 경제
   - 국제통상학과: 수학, 영어, 경제, 사회문화, 정치와법
   - 사회학전공: 사회문화, 윤리
   - 미디어커뮤니케이션학전공: 국어, 경제, 사회문화, 정치와법
   - 식품산업관리학과: 수학, 경제, 사회문화
   - 광고홍보학과: 국어, 영어, 사회문화
   - 사회복지학과: 윤리, 사회문화, 정치와법, 경제
   ◆ 경찰사법대학
   - 경찰행정학부: 수학, 영어, 사회문화, 정치와법
   ◆ 경영대학
   - 경영학과 / 회계학과 / 경영정보학과: 국어, 영어, 수학, 사회문화, 경제
   ◆ 바이오시스템대학
   - 단과대학모집(통합): 수학, 화학, 생명과학
   - 융합환경과학과: 수학, 화학, 생명과학, 지구과학
   - 생명과학과 / 의생명공학과: 수학, 물리학, 화학, 생명과학
   - 식품바이오융합공학과: 수학, 화학, 생명과학
   ◆ 공과대학
   - 전자전기공학부 / 정보통신공학과: 수학, 물리학
   - 건설환경공학과: 수학, 물리학, 화학, 지구과학
   - 화공생물공학과: 수학, 물리학, 화학, 생명과학
   - 기계로봇에너지공학과 / 건축공학부: 수학
   - 산업시스템공학과 / 에너지신소재공학과: 수학, 물리학, 화학
   ◆ 첨단융합대학
   - 컴퓨터AI학부: 수학
   - 시스템반도체학부: 수학, 물리학, 화학
   - 의료인공지능공학과 / 지능형네트워크융합학과: 수학, 물리학
   ◆ 사범대학
   - 교육학과: 사회문화, 역사, 윤리
   - 국어교육과: 국어, 사회문화, 역사, 윤리
   - 역사교육과: 역사 | 지리교육과: 지리 | 수학교육과: 수학
   - 가정교육과: 화학, 생명과학, 사회문화, 기술·가정
   ◆ 약학대학
   - 약학과: 수학, 화학, 생명과학
   ◆ 미래융합대학
   - 범죄학과: 사회문화, 정치와법, 윤리
   - 사회복지상담학과: 사회문화, 윤리
   - 글로벌무역학과: 국어, 수학, 영어, 사회문화, 경제
`,
      competencies: {
        academic: "학업역량(기초학업역량+학습의주도성) — Do Dream·불교·기회균형 30% / 학교장추천 50%",
        career: "전공적합성(전공수학역량+진로탐색노력) — Do Dream·불교·기회균형 50% / 학교장추천 진로역량 30%",
        community: "인성및사회성(역할의주도성+협업소통능력) — 전 전형 공통 20%"
      },
      weights: { academic: 0.25, career: 0.55, community: 0.20 },
    },
    "\ud64d\uc775\ub300\ud559\uad50": {
      factors: `
[홍익대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 전형 유형 및 선발 방식
   학교생활우수자 (인문·자연계열):
     서류평가 100% 일괄합산 (면접 없음)
     수능 최저 [서울캠퍼스]: 국·수·영·탐(1) 중 2개 영역 등급 합 5 이내 + 한국사 4등급 이내
     수능 최저 [세종캠퍼스]: 없음 (2027학년도부터 세종캠퍼스 수능최저 폐지)
     ※ 서울 2합5로 상향 강화 / 세종 수능최저 완전 폐지 → 세종 실질 경쟁률 대폭 상승 예상
   미술우수자 (미술계열):
...
■ 평가 주안점
   ...
   4. 수능최저 전략 (서울): 2개 영역 합 5 이내 — 매우 높은 기준으로 실질 경쟁률 크게 낮아짐, 서류 준비와 수능 2과목 집중 관리 필수
...
■ 평가 주안점 (종합)
   ...
   2. 수능최저 전략: 서울캠퍼스 2합5이내 강화 — 내신 관리와 수능 2과목 집중 병행
      세종캠퍼스 수능최저 없음 → 서류(학생부) 경쟁력이 합격을 결정
...
■ 2027학년도 주요 변경사항
   학교생활우수자 서울: 수능최저 3합8 → 2합5 (2개 영역으로 축소, 기준 대폭 상향)
   학교생활우수자 세종: 수능최저 2합9 → 없음 (완전 폐지)
   ※ 서울 수능최저 강화로 실질 경쟁 감소 / 세종 폐지로 세종 경쟁률 상승 예상`,
      competencies: {
    ...
    "성균관대학교": {
      factors: `
[성균관대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 전형별 서류평가 구조
   융합인재(329명): 서류100% 일괄합산 — 수능최저有 (4개 중 3개 합 6이내)
   탐구인재(589명): 서류100% 일괄합산 — 수능최저 완전 미적용
   성균인재(196명)·과학인재(155명): 1단계 서류70%+면접30% (7배수 내외)
   기회균형(28명): 서류100% 일괄합산 — 수능최저 미적용

■ 서류평가 6개 영역 3대 역량 (총점 1000점)
   학업역량 40%(400점) + 탐구역량 40%(400점) + 잠재역량 20%(200점)

   ◆ 학업역량 [40% / 400점]
   ✦ 학업수월성 (200점): 전반적인 학업성취도, 선택과목 이수 노력, 전 과목 학업 우수성
      → 수강자수·원점수·표준편차 등 맥락을 고려한 정성 해석 (등급만으로 판단 금지)
   ✦ 학업충실성 (200점): 학업에 대한 관심·열의, 학년별 성적 안정성과 학업의지, 수업 참여도

   ◆ 탐구역량 [40% / 400점]
   ✦ 탐구확장성 (200점): 관심 분야 집중력·지적 호기심, 활동 내용의 심화·발전성
   ✦ 탐구주도성 (200점): 자기주도적 탐구 노력, 도전적 선택과목 이수, 진로 탐색 의지
...
■ 학생부 평가 근거
   학업역량: 교과이수현황 · 세부능력및특기사항(교과학습·과제수행) · 행동특성및종합의견
   탐구역량: 세부능력및특기사항(탐구·발표·연구) · 교과이수현황(도전과목) · 동아리 · 진로활동
   잠재역량: 창의적체험활동(자율·동아리·봉사) · 행동특성및종합의견 · 출결현황

■ 평가 방식: 입학사정관 2인 1조 독립·교차평가 → 편차 발생 시 추가평가 → 서류평가위원회 최종 확정
■ 동점자 처리: 융합인재·과학인재·기회균형 → 학업수월성 우선 / 탐구인재·성균인재 → 탐구확장성 우선
`,
      competencies: {
        academic: "학업역량(학업수월성200점+학업충실성200점) — 40% / 400점",
        career: "탐구역량(탐구확장성200점+탐구주도성200점) — 40% / 400점",
        community: "잠재역량(미래성장성100점+공동체의식100점) — 20% / 200점"
      },
      weights: { academic: 0.40, career: 0.40, community: 0.20 }
    },    "\uad6d\ubbfc\ub300\ud559\uad50": {
      factors: `

[국민대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 반영 전형: 국민프런티어전형, 기회균형Ⅰ전형, 성인학습자전형, 국제인재전형(신설), 알고리즘우수자전형(신설)

■ 전형 유형 및 전형방법 (전 전형 수능최저 없음)
   국민프런티어 (724명): 1단계(3배수) 서류100% → 2단계 서류70%+면접30%
   국제인재 (15명): 1단계(3배수) 서류100% → 2단계 서류70%+면접30% / 2027학년도 신설
   알고리즘우수자 (10명): 1단계(3배수) 서류100% → 2단계 서류70%+면접30% / 2027학년도 신설
   기회균형Ⅰ (122명): 1단계(3배수) 서류100% → 2단계 서류70%+면접30%
   성인학습자 (20명): 1단계(3배수) 서류100% → 2단계 서류70%+면접30%

■ 3대 평가 요소 및 반영 비율 (2027학년도 개편 기준)

   [국민프런티어·기회균형Ⅰ·성인학습자]
   진로역량 (40점): 전공계열관련교과성취도및이수노력(15점) + 진로탐색활동과경험(25점)
   학업역량 (30점): 학업성취도및학업태도(15점) + 탐구력(15점)
   공동체역량 (30점): 협업과소통능력·나눔과배려·리더십(20점) + 성실성과규칙준수(10점)

   [국제인재·알고리즘우수자 — 진로역량 비중 대폭 상향]
   진로역량 (50점): 전공계열관련교과성취도및이수노력(20점) + 진로탐색활동과경험(30점)
   학업역량 (20점): 학업성취도및학업태도(10점) + 탐구력(10점)
   공동체역량 (30점): 협업과소통능력·나눔과배려·리더십(20점) + 성실성과규칙준수(10점)

■ 면접평가 기준 (2단계 / 30% 반영)
   방식: 블라인드 개별 면접, 10분 이내, 입학사정관 2인 : 수험생 1인
   내용: 제출서류(학생부) 확인 면접 — 기재 활동의 진위 및 역량 검증
   평가항목: 진로역량 / 학업역량 / 공동체역량 (서류평가와 동일 역량 구조)
   ※ 면접 결시·'F' 판정 시 불합격 처리

■ 평가 주안점
   1. 진로역량이 핵심 (40~50%): 전공 관련 교과 이수 노력·성취와 진로탐색 활동의 진정성·구체성
   2. 탐구 활동의 지속성: 학교 수업 내 능동적 탐구 과정 및 지속적 활동 양상
   3. 면접 10분 진위 확인: 학생부 기재 활동을 질의응답으로 검증 — 실제 경험·이해도 확인이 핵심
   4. 국제인재·알고리즘우수자: 진로역량 50% — 전공 분야 전문성 심화 관심이 당락 결정

■ 서류평가 방식
   입학사정관 2인이 블라인드 독립 정성 평가 (성명·고교명 미공개)
   학교폭력 조치사항: 공동체역량에서 정성 반영

■ 평가 주안점 (종합)
   1. 진로역량 40~50%: 전공 관련 이수과목 선택 + 진로탐색 활동 일관성이 가장 중요
   2. 면접 30%: 서류에서 확인되지 않는 역량을 면접으로 재검증, 결시 시 불합격
   3. 학교폭력 조치: 공동체역량에서 반영 — 내신+활동 우수해도 불합격 가능
   4. 신설 전형 주의: 국제인재·알고리즘우수자 진로역량 50% → 전공 전문성 집중 준비 필요
   5. 수능최저 없음: 전 전형 학생부종합 수능최저 미적용 — 내신+활동 경쟁

■ 2027학년도 주요 변경사항
   국제인재전형 신설 (15명): International College KMU IBS 대상, 진로역량 50%
   알고리즘우수자전형 신설 (10명): 소프트웨어·인공지능학부, 알고리즘 역량 중심
   소프트웨어특기자전형 폐지 → 알고리즘우수자전형으로 전환
   기회균형Ⅰ 지원자격 변경: 특성화고교졸업자 제외
   교과전형 명칭 변경: 교과성적우수자전형 → 교과우수자(학교장추천)전형
   평가체계 개편: 전공적합성+자기주도성+인성 → 진로역량+학업역량+공동체역량
`      ,
      competencies: {
        academic: "학업역량(학업성취도·학업태도·탐구력) — 국민프런티어 30점 / 국제인재·알고리즘우수자 20점. 전공 관련 심화 학습 및 탐구 역량 평가",
        career: "진로역량(전공계열관련교과성취도및이수노력·진로탐색활동과경험) — 국민프런티어 40점 / 국제인재·알고리즘우수자 50점. 전공 탐색의 진정성·일관성이 핵심",
        community: "공동체역량(협업과소통능력·나눔과배려·리더십·성실성과규칙준수) — 30점 전 전형 공통. 학교폭력 조치사항 정성 반영"
      },
      weights: { academic: 0.30, career: 0.40, community: 0.30 }
    },
    "\uc22d\uc2e4\ub300\ud559\uad50": {
...
[숭실대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강·가이드북 반영]

■ 2027학년도 전형 이원화 (핵심 변경사항)
   SSU미래인재(면접형) 522명: 1단계(3~3.5배수) 서류100% → 2단계 1단계50%+면접50%
   SSU미래인재(서류형) 163명 [신설]: 서류100% 일괄합산 / 면접 없음
   기회균형전형 130명: 1단계(3배수) 서류100% → 2단계 1단계50%+면접50%
   SW우수자전형 17명: 1단계(3배수) 서류100% → 2단계 1단계50%+면접50%
   특수교육대상자전형 38명: 1단계(3배수) 서류100% → 2단계 1단계50%+면접50%
   ※ 전 전형 수능최저학력기준 없음

■ 서류평가 기준 — SSU미래인재(면접형) · 기회균형 · SW우수자 · 특수교육 (서류종합평가)
   학업역량 (20%): 학업성취도 — 고교 교육과정 이수 학업성취 수준
   진로역량 (50%): 전공(계열)진로탐색노력(자기주도적 실행노력·수업 적극 참여도·학업 열의)
                   + 선택과목이수적절성(지원 전공(계열)에 필요한 과목 이수 내용)
   공동체역량 (30%): 협력적소통(타인 존중·의사표현·공동체 협력) + 성실성(출결·봉사)
                     + 인성(공동체 윤리·원칙 준수, 학교폭력 조치사항 반영)

■ 서류평가 기준 — SSU미래인재(서류형) [신설 / 탐구역량 중심]
   학업역량 (10%): 학업성취도 — 고교 교육과정 이수 학업성취 수준
   탐구역량 (60%): 탐구활동의깊이와과정
                   - 관심 분야 탐구활동 과정의 주도성
                   - 교과 지식 연계 및 다양한 자료 활용의 적절성
                   - 탐구 결과 분석의 논리성 및 결론 도출의 합리성
   공동체역량 (30%): 협력적소통 + 성실성 + 인성 (면접형과 동일)

■ 면접평가 기준 (2단계 / 50% 반영 — 면접형·기회균형·SW우수자·특수교육)
   방식: 서류 기반 블라인드 면접, 12분 내외, 면접위원 2인 : 지원자 1인
   블라인드: 성명·수험번호·출신고교·부모 직업 정보 등 블라인드 처리
   전공적합성 (50%):
     - 전공준비도: 지원 전공에 대한 이해도와 구체적인 지원동기
     - 전공탐구노력: 전공 관련 탐구활동의 탐구 동기·과정·자기평가·발전가능성
   잠재력 (50%):
     - 자기평가력: 진로탐색 과정에서 목표에 자기를 평가하며 개선·발전 실행 노력
     - 발전가능성: 면접 전반에 드러나는 인성·면접태도·숭실 공동체 적응가능성
   ※ SW우수자전형: SW 관련 경험활동에 근거한 논리적 사고 및 표현 평가

■ 서류 평가 절차
   2인의 사정관이 지원자 1인을 독립 평가 → 일정 점수 이상 차이 발생 시 재평가
   입학전형 공정관리위원회 심의 → 합격자 입학사정위원회 결정
   1단계 배수: 인문대학·국제법무학과·정보보호학과 3배수 / 그 외 모든 모집단위 3.5배수

■ 평가 주안점
   1. 진로역량 50% (면접형): 전공(계열) 관련 진로 탐색의 자기주도적 실행노력이 핵심
   2. 탐구역량 60% (서류형): 관심 분야 탐구의 깊이·주도성·교과 연계·논리적 결론 도출
   3. 면접 50%: 서류 기재 내용의 진위·이해도·발전가능성을 12분간 집중 검증
   4. 선택과목 이수: 지원 전공에 필요한 교과를 전략적으로 이수했는지 평가
   5. 학교폭력 조치: 4~7호 정성평가 차등 감점(1~4점), 8~9호 부적격 불합격

■ 2027학년도 주요 변경사항
   SSU미래인재전형 이원화: 면접형(522명) + 서류형(163명) 신설
   면접형 1단계 배수 확대: 3배수 → 3~3.5배수 (인문·국제법무·정보보호 3배수, 나머지 3.5배수)
   논술우수자 수능최저 완화: 2합5이내 → 2합6이내
   교과우수자 수능최저 완화: 자연계 과탐 필수 → 사탐/과탐 모두 인정
   논술 반영비율 변경: 논술80%+교과20% → 논술90%+교과10%
   모집단위 개편: 전자정보공학부(전자공학/IT융합) → 지능전자공학부
`      ,
      competencies: {
        academic: "학업역량(학업성취도) — 면접형·기회균형·SW우수자·특수교육 20% / 서류형 10%. 고교 교육과정 이수 학업성취 수준",
        career: "진로역량·탐구역량 — 면접형 진로역량50%(전공계열진로탐색노력+선택과목이수적절성) / 서류형 탐구역량60%(탐구활동의깊이와과정·주도성·교과연계·논리성)",
        community: "공동체역량(협력적소통·성실성·인성) — 30% 전 전형 공통. 학교폭력 4~7호 차등감점(1~4점), 8~9호 부적격"
      },
      weights: { academic: 0.20, career: 0.50, community: 0.30 }
    },
    "\uc138\uc885\ub300\ud559\uad50": {
      factors: `
[세종대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 2027학년도 학생부종합 전형 구성
   세종인재 전형(면접형) 364명: 1단계(3배수) 서류100% → 2단계 1단계60%+면접40%
   세종인재 전형(서류형) 260명 [구 세종창의인재전형]: 서류100% 일괄합산
   기회균형 전형 99명: 서류100%
   사회기여 및 배려자 전형 42명: 서류100%
   ※ 전 전형 수능최저학력기준 없음

■ 서류평가 3대 요소 (2027 개편 — 4대→3대 통합)
   창의융합역량: 관심 분야 관련 교과목 이수 노력/성취도 + 자기주도적 탐색 활동과 확산 노력
   학업역량: 학업성취도 + 학업태도 + 탐구력
   공동체역량: 성실성 및 규칙준수 + 나눔과 배려 + 협력과 소통능력 + 리더십

■ 전형별 서류평가 반영비율
   세종인재(면접형): 창의융합역량50% + 학업역량30% + 공동체역량20%
   세종인재(서류형): 창의융합역량45% + 학업역량25% + 공동체역량30%
   기회균형/사회기여/서해5도/특성화고: 창의융합역량40% + 학업역량30% + 공동체역량30%

■ 면접평가 요소 (면접형 2단계)
   탐구역량(관심분야 기본소양·학업의지) 40%
   성장역량(자기주도성·성장가능성·도전정신) 40%
   공동체역량(소통능력·공동체적 가치관·진실성) 20%

■ 2027학년도 주요 변경사항
   전형명 변경: 세종창의인재 전형(면접형·서류형) → 세종인재 전형(면접형·서류형)
   세종인재 면접형 모집인원 확대: 338명 → 364명
   세종인재 서류형 모집인원 확대: 200명 → 260명
   면접형 1단계 배수 통일: 전 모집단위 3배수 (기존 일부 4배수 → 3배수)
   논술우수자 전형: 논술70%+교과30% → 논술80%+교과20%
`,
      competencies: {
        academic: "학업역량(학업성취도·학업태도·탐구력) — 면접형 30% / 서류형 25% / 기회균형 등 30%",
        career: "창의융합역량(관심분야 교과이수노력·성취도·자기주도적 탐색 확산) — 면접형 50% / 서류형 45% / 기회균형 등 40%",
        community: "공동체역량(성실성·규칙준수·나눔·배려·협력·소통·리더십) — 면접형 20% / 서류형 30% / 기회균형 등 30%"
      },
      weights: { academic: 0.30, career: 0.50, community: 0.20 }
    },
    "\ub2e8\uad6d\ub300\ud559\uad50": {
      factors: `
[단국대학교(죽전) 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 2027학년도 학생부종합 전형 구성 (죽전캠퍼스)
   DKU인재(서류형) 266명: 서류100% 일괄합산
   DKU인재(면접형) 159명: 1단계(3배수) 서류100% → 2단계 1단계70%+면접30%
   SW인재 34명: 1단계(3배수) 서류100% → 2단계 1단계70%+면접30%
   창업인재 12명: 1단계(3배수) 서류100% → 2단계 1단계70%+면접30%
   기회균형선발 83명 / 사회적배려대상자 71명: 서류100%
   ※ 전 전형 수능최저학력기준 없음

■ 서류평가 요소 및 반영비율 (계열광역 모집단위 제외)
   [DKU인재(서류형)]
   학업역량: 학업성취도(25%) + 탐구력(20%) = 45%
   진로역량: 진로의지(15%) + 진로탐색활동과경험(20%) = 35%
   공동체역량: 도덕성및성실성(10%) + 협업과소통(10%) = 20%
   [DKU인재(면접형) · SW인재]
   학업역량: 학업성취도(20%) + 탐구력(15%) = 35%
   진로역량: 진로의지(20%) + 진로탐색활동과경험(25%) = 45%
   공동체역량: 도덕성및성실성(10%) + 협업과소통(10%) = 20%
   [기회균형선발 · 사회적배려대상자 · 정원외]
   학업역량: 학업성취도(20%) + 탐구력(20%) = 40%
   진로역량: 진로의지(15%) + 진로탐색활동과경험(20%) = 35%
   공동체역량: 도덕성및성실성(15%) + 협업과소통(10%) = 25%

■ 계열광역 모집단위 서류평가 비율 (DKU인재(서류형)·SW인재·기회균형선발)
   학업역량: 학업성취도(20%) + 탐구력(15%) = 35%
   성장역량: 성장의지(20%) + 탐색활동과경험(25%) = 45%
   공동체역량: 도덕성및성실성(10%) + 협업과소통(10%) = 20%

■ 창업인재 서류평가 비율
   학업역량: 학업성취도(20%) + 탐구력(15%) = 35%
   진로역량: 진로의지(20%) + 진로탐색활동(10%) + 창업활동(15%) = 45%
   공동체역량: 도덕성및성실성(10%) + 협업과소통(10%) = 20%

■ 면접평가 요소 (DKU인재(면접형) · SW인재 · 창업인재 2단계)
   진로역량(진로의지: 전공관심·이해·탐색활동 성과) 50%
   발전가능성(목표의식: 진로계획 의지와 태도) 30%
   공동체역량(공동체의식·소통능력) 20%

■ 2027학년도 주요 변경사항
   AI건축융합학과 신설 (죽전캠퍼스 AI융합계열)
   뮤지컬전공(연출) 신설 (죽전캠퍼스 음악·예술대학)
   창업인재 전형 신설: 12명 선발 (면접형, 1단계70%+면접30%)
`,
      competencies: {
        academic: "학업역량(학업성취도·탐구력) — DKU서류형 45% / DKU면접형·SW 35% / 기회균형 40% / 계열광역 35%",
        career: "진로역량(진로의지·진로탐색활동과경험) — DKU서류형 35% / DKU면접형·SW 45% / 계열광역 성장역량 45% / 창업인재 45%",
        community: "공동체역량(도덕성및성실성·협업과소통) — DKU서류형·면접형·SW·창업인재 20% / 기회균형 25%"
      },
...
`,
    ...
    "\uad11\uc6b4\ub300\ud559\uad50": {
      factors: `
[광운대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강·가이드북 반영]

■ 2027학년도 학생부종합 전형 구성
   광운참빛인재전형I(면접형) 250명: 1단계(3.5배수) 서류100% → 2단계 1단계60%+면접40%
   광운참빛인재전형II(서류형) 221명: 서류100% 일괄합산
   소프트웨어우수인재전형 72명: 1단계(3.5배수) 서류100% → 2단계 1단계60%+면접40%
   농어촌학생 39명 / 특성화고졸업자 25명 / 특성화고재직자 120명 / 서해5도 6명
   ※ 전 전형 수능최저학력기준 없음

■ 서류종합평가 항목 및 반영비율
   [광운참빛인재전형I(면접형) · 소프트웨어우수인재전형]
   학업역량 25% / 진로역량 50% / 공동체역량 25%
   [광운참빛인재전형II(서류형) · 농어촌 · 특성화고 · 재직자 · 서해5도]
   학업역량 35% / 진로역량 45% / 공동체역량 20%

■ 서류평가 3대 요소 세부 기준
   학업역량 — 학업성취도 및 학업발전성 / 학업성실성(수업 참여·책임감·꾸준한 노력)
   진로역량 — 진로 관련 분야 자기주도성(지속적 탐색·도전) / 발전가능성(지적 호기심·탐구 확장)
              전공(계열) 관련 교과 이수 노력 / 전공(계열) 관련 교과 성취도
   공동체역량 — 협업과 소통능력 / 학교생활 충실도와 규칙준수

■ 면접평가 항목 및 반영비율 (면접형 · SW우수인재 2단계)
   발전가능성(전공 분야 관심·이해·지적탐구 노력) 45%
   종합적사고력(의사소통능력·답변의 적절성) 30%
   인성(공동체적 가치관·면접 태도) 25%

■ 동점자 처리기준 (서류형 · 농어촌 · 특성화고 · 재직자 · 서해5도)
   1순위: 진로역량 / 2순위: 학업역량 / 3순위: 미인정 결석 총 횟수(2027 강화)

■ 2027학년도 주요 변경사항
   학과명 변경: 영어산업학과 → 영어영문학과
   지역균형전형 지원자격 변경: 3개 학기 이상 이수 → 5개 학기 이상 이수
   서류형 동점자 처리 강화: 기존 2순위(학업역량) → 3순위에 출결상황 추가
   체육특기자전형 지원자격 완화: 경기시간 70% 이상 출전 → 50% 이상 출전
`,
      competencies: {
        academic: "학업역량(학업성취도·학업발전성·학업성실성) — 면접형·SW 25% / 서류형·농어촌 등 35%",
        career: "진로역량(자기주도적 탐색·발전가능성·전공 교과 이수 노력·성취도) — 면접형·SW 50% / 서류형·농어촌 등 45%",
        community: "공동체역량(협업과 소통능력·학교생활 충실도와 규칙준수) — 면접형·SW 25% / 서류형·농어촌 등 20%"
      },
      weights: { academic: 0.35, career: 0.45, community: 0.20 }
    },
    "\uacbd\uae30\ub300\ud559\uad50": {
...
`,
    ...
    "서강대학교": {
      factors: `
[서강대학교 2027학년도 학생부종합전형 서류평가 기준]

■ 평가 철학: "경계 없는 다전공제도" 기반 — 특정 전공 적합성보다 지원자의 성장가능성을 핵심 평가 주안점으로 삼음

■ 전형별 선발 구조
   일반I(494명)·일반II(74명): 서류100%(3배수) → 1단계50%+면접50% / 수능최저 없음
   기회균형(85명): 서류100%(3배수) → 서류50%+면접50% / 수능최저 없음
   서강가치(34명): 서류100% 일괄합산 / 수능최저 없음

■ 서류평가 3대 역량 및 배점
   학업능력 50% + 공동체역량 30% + 성장가능성 20%
...
■ 학생부 평가 근거
   학업능력: 세부능력및특기사항(교과학습·수업태도·탐구) · 교과이수현황 · 행동특성및종합의견
   공동체역량: 창의적체험활동(동아리·봉사·자율) · 행동특성및종합의견 · 출결현황
   성장가능성: 진로활동 · 세부능력및특기사항(자기주도 탐구·발표) · 자율활동 · 동아리활동

■ 블라인드 평가: 수험번호·이름·출신고교·사진 비공개
■ 평가 방식: 1·2차 독립 정성 종합평가, 점수 차이 발생 시 추가 평가 절차
`,
      competencies: {
        academic: "학업능력(학업성취도·학업태도·탐구역량) — 50%",
        career: "성장가능성(지적열정·자기주도성·성장과정) — 20% ★ 서강대 핵심",
        community: "공동체역량(공동체역할·봉사·소통능력) — 30%"
      },
      weights: { academic: 0.50, career: 0.20, community: 0.30 }
    },"한양대학교": {
      factors: `
[한양대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 평가 철학: 횡단평가(Cross-sectional) — 여러 교사의 기록을 연결해 학생의 역량을 입체적으로 평가
   전공 적합성보다 계열 적합성 중시 — 특정 전공명 일치 활동보다 계열 내 깊이 있는 사고 과정 평가

■ 전형별 서류평가 구조
   서류형(518명)·추천형(300명)·고른기회(113명)·사회통합(5명): 학생부종합평가 100% 일괄합산
   면접형(138명): 1단계 서류100%(7배수) → 2단계 1단계70%+면접30%
   추천형·교과추천형·논술: 수능최저 적용 (국·수·영·탐 3개 합 7이내, 의예과 합 4이내)

■ 4개 역량 평가 구조

   ◆ 기초학업역량 [35%] — 종합역량평가 단계
   ✦ 학업성취도: 교과 성취 수준 및 발전 정도 (등급+이수단위+원점수 복합 정성 해석)
   ✦ 교과목 이수 충실도: 선택과목의 적절성, 계열 관련 교육과정 이수 노력
   ✦ 학업 성실성: 학년별 발전 정도와 꾸준한 노력 태도

   ◆ 심층학업역량 [40%] ★ 가장 중요 — 성취역량평가 단계
   ✦ 비판적 사고: 배운 내용을 분석·비교·적용하는 사고 과정 (세특에 탐구 과정이 드러나야 함)
   ✦ 창의적 탐구: 새로운 현상·문제에 스스로 질문하고 깊이 있게 탐구한 경험
   ✦ 문제해결력: 논리적으로 해결해 나가는 과정 — 결과보다 사고 과정과 탐구 깊이가 핵심

   ◆ 진로탐구역량 [15%] — 성취역량평가 단계
   ✦ 계열 관련 성취: 관심 계열 교과 이수 및 성취 (전공이 아닌 계열 관점 — 폭넓게 해석)
   ✦ 탐색 과정: 계열 자기주도적 탐색 — 활동 다양성보다 깊이와 일관성 중시

   ◆ 공동체역량 [10%] — 성취역량평가 단계
   ✦ 소통과 협업: 공동 활동에서의 실질적 기여와 타인 존중
   ✦ 책임감과 성장: 직책 유무 무관 — 공동체에서 긍정적 변화를 이끈 실질 사례 평가

■ 학생부 평가 근거
   기초학업역량: 교과이수현황 · 세부능력및특기사항(수업참여·과제수행) · 행동특성및종합의견
   심층학업역량: 세부능력및특기사항(사고과정·탐구심도·발표·토론·질문 기록)
   진로탐구역량: 세특(계열 관련 탐구) · 교과이수현황(계열 관련 과목) · 동아리 · 진로활동
   공동체역량: 창의적체험활동(동아리·봉사·자율) · 행동특성및종합의견 · 출결현황

■ 다단계 평가 프로세스
   ① 종합역량평가 (전임사정관 2인 독립평가) → ② 성취역량평가 (전임+위촉사정관)
   → ③ 재심위원회 (편차 발생 시, 전임사정관 5인) → ④ 고교방문실사 (추가 확인 필요시)
`,
      competencies: {
        academic: "기초학업역량(학업성취도·이수충실도·성실성) — 35%",
        career: "심층학업역량(비판적사고·창의탐구·문제해결력) 40% ★ + 진로탐구역량(계열적합·탐색과정) 15%",
        community: "공동체역량(소통·협업·책임감·실질기여) — 10%"
      },
      weights: { academic: 0.35, career: 0.55, community: 0.10 }
    },"중앙대학교": {
      factors: `
[중앙대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ Two-Track 인재상 — 강점에 따른 전략적 전형 선택 필요

   🔵 융합형인재(378명): 학업+교내활동 균형 성장 중심 — 학업역량50%+진로역량30%+공동체역량20%
   🔴 탐구형인재(512명): 전공(계열) 심화 탐구 중심 — 학업역량40%+진로역량50%+공동체역량10%
   🟡 성장형인재(108명, 신설): 균형 성장+수능최저 — 학업역량50%+진로역량30%+공동체역량20%
   ⚪ 어울림(20명)·기회균형: 학업50%+진로30%+공동체20%

■ 3대 서류평가 역량

   ◆ 학업역량
   ✦ 교과 성취도: 원점수·성취도 분포·이수인원·과목위계 복합 고려한 정성 해석 (등급만으로 판단 금지)
   ✦ 학년별 성적 추이: 기초교과(국·수·영·사·과) 안정적 이수 및 학습 노력의 일관성
   ✦ 탐구심·지적 호기심: 교과 활동 속 스스로 탐구하고 학습을 심화한 경험

   ◆ 진로역량
   ✦ [탐구형 50% 핵심] 전공 분야 심화 탐구 깊이·진정성, 장기간 지속된 탐구 흔적
      → 세특에서 깊이 있는 사고 발전 과정이 명확히 드러나야 함
   ✦ [융합형/성장형 30%] 다양한 경험을 통한 진로 탐색·확장 과정
      → 진로 변화 자체도 긍정 평가 — 탐색 과정의 자연스러움과 의도성이 중요
   ✦ 공통: 전공(계열) 관련 교과 이수 노력과 성취도, 세특의 탐구 이해도

   ◆ 공동체역량
   ✦ 실질적 협력과 기여: 직책보다 책임감·문제해결 능력, 구체적 협력 경험
   ✦ 성실성: 출결 상황, 학교 규칙 준수 (결석·지각·조퇴 기록 감점 요소)
   ✦ 탐구형 10% / 융합형·성장형·어울림 20%

■ 학생부 평가 근거
   학업역량: 교과이수현황 · 세부능력및특기사항(교과학습) · 행동특성및종합의견
   진로역량: 세부능력및특기사항(탐구·발표) · 교과이수현황(전공관련) · 동아리 · 진로활동
   공동체역량: 창의적체험활동(동아리·봉사·자율) · 행동특성및종합의견 · 출결현황

■ 전형별 수능최저 — 서울캠 성장형: 국·수·영·탐 3개 합 6이내 / 지역균형·논술일반형(서울): 합 7이내
`,
      competencies: {
        academic: "학업역량(원점수·분포·위계 정성해석·성적추이·탐구심) — 탐구형 40% / 융합형·성장형 50%",
        career: "진로역량(탐구형:심화탐구 깊이·진정성 50%★ / 융합형:다양한 진로탐색·확장 30%)",
        community: "공동체역량(실질기여·성실성·규칙준수) — 탐구형 10% / 융합형·성장형 20%"
      },
      weights: { academic: 0.45, career: 0.40, community: 0.15 }
    },    "한국교원대학교": {
      factors: `
...
`,
    ...
    "\uba85\uc9c0\ub300\ud559\uad50": {
      factors: `
[명지대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 2027학년도 학생부종합 전형 구성
   명지인재면접전형 379명: 1단계(4배수) 서류100% → 2단계 1단계70%+면접30%
   명지인재서류전형 361명: 서류100% 일괄합산
   크리스천리더전형 52명: 1단계(4배수) 서류100% → 2단계 1단계70%+면접30% (기독교 신자 필수)
   사회적배려대상자전형 35명: 서류100% 일괄합산
   농어촌학생전형 93명: 서류100% 일괄합산
   ※ 전 전형 수능최저학력기준 없음
   ※ 인문캠퍼스(서울 서대문구) + 자연캠퍼스(용인) 이원 운영

■ 서류평가 항목 및 반영비율
   [명지인재면접전형 · 크리스천리더전형]
   학업역량 20% / 진로역량 50% / 공동체역량 30%
   [명지인재서류전형 · 사회적배려대상자전형 · 농어촌학생전형]
   학업역량 30% / 진로역량 50% / 공동체역량 20%

■ 서류평가 3대 요소 세부 기준
   학업역량 — 학업성취도(고교 교과 성취수준) / 학업태도(자기주도적 학습 의지와 노력)
   진로역량 — 진로설계역량(진로 연계 과목 선택·이수 정도)
              진로학업역량(진로 연계 이수 과목의 학업 성취수준)
              진로탐색역량(진로 연계 교과/비교과 활동 및 탐색 활동 수행 정도)
   공동체역량 — 성실성과 규칙준수(책임감 바탕 의무 이행·공동체 윤리 준수)
               협업과 소통능력(공동체 목표 달성 협력·구성원과 합리적 의사소통)

■ 면접평가 항목 (명지인재면접전형 · 크리스천리더전형 2단계)
   진로역량 40% — 진로탐색 활동과 경험
   공동체역량 30% — 성실성, 공동체의식, 소통능력
   발전가능성 30% — 자기주도성, 도전정신
   ※ 면접: 개별면접(면접위원 2명), 약 10분, 서류 기반 심층면접, 블라인드

■ 서류평가 등급: A+ A B+ B C+ C D (7등급 판정)

■ 동점자 처리기준 (서류형)
   ① 서류평가 진로역량 → ② 서류평가 학업역량 → ③ 서류평가 공동체역량-협업과소통능력 순

■ 2027학년도 주요 변경사항
   AI 명칭 강화: 경영정보학과→AI경영정보학과, 컴퓨터정보통신공학부→컴퓨터AI응용공학부
   전기전자공학부 분리선발: 전기정보공학전공·전자공학전공 별도 지원
   미래융합대학 학사구조 개편: 창의융합인재학부 등→미래전략학부+융합인재학부
   학교장추천전형 지원자격 강화: 2025년 2월 이후 졸업(예정)자로 제한
   자율전공학부(인문·자연) 교과면접·명지인재면접 신규 선발
`,
      competencies: {
        academic: "학업역량(학업성취도·학업태도) — 면접형 20% / 서류형·농어촌·배려 30%",
        career: "진로역량(진로설계역량·진로학업역량·진로탐색역량) — 전 전형 50% 동일",
        community: "공동체역량(성실성과 규칙준수·협업과 소통능력) — 면접형 30% / 서류형·농어촌·배려 20%"
      },
      weights: { academic: 0.30, career: 0.50, community: 0.20 }
    },
    "\uc0c1\uba85\ub300\ud559\uad50(\uc11c\uc6b8)": {
      factors: `
[상명대학교(서울) 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 2027학년도 학생부종합 전형 구성 (서울캠퍼스)
   상명인재전형 155명: 1단계(5배수) 서류100% → 2단계 서류60%+면접40%
   (단, 스포츠건강관리전공·조형예술전공만 2단계 면접 실시)
   일반 모집단위: 서류100% 일괄합산
   기회균형전형 70명: 서류100% 일괄합산
   특성화고졸재직자전형: 정원내 1명 + 정원외 123명, 서류100%
   ※ 전 전형 수능최저학력기준 없음

■ 서류평가 항목 및 반영비율
   학업역량 35% = 학업성취도(15%) + 학업태도(20%)
   진로역량 45% = 진로탐색활동과경험(25%) + 자기주도성및실천능력(20%)
   공동체역량 20% = 성실성및협업태도(20%)

■ 서류평가 세부 평가내용
   학업성취도(15%) — 고교 교육과정 내에서 이루어지는 학업적 노력 및 성취 수준
   학업태도(20%) — 교과 활동을 통해 드러나는 학업 의지 및 성장 노력
   진로탐색활동과경험(25%) — 관심 분야 탐색 노력·준비 정도, 관련 활동의 내용 및 성취
   자기주도성및실천능력(20%) — 목표 달성 과정의 자기주도성·문제해결능력·극복 경험
   성실성및협업태도(20%) — 규칙준수, 책임감, 협동, 타인 이해·배려 / 학교폭력 조치 반영

■ 면접평가 (상명인재전형 스포츠건강관리전공·조형예술전공 2단계)
   학업역량(학업태도및탐구력) 20%
   진로역량(진로탐색활동과경험+자기주도성및실천능력) 50%
   공동체역량(사회성및협업태도) 30%
   ※ 서류기반 개별면접 | 면접위원 2인·수험생 1인 | 10분 내외 | 블라인드

■ 평가방식
   학교생활기록부 기반 종합적 정성평가 (교과 정량평가 없음)
   블라인드 서류평가 (수험번호·성명·주민번호·사진·출신고교 블라인드)
   반영점수: 최고 100점 / 최저 0점

■ 동점자 처리기준
   ① 진로역량(진로탐색활동과경험) → ② 진로역량(자기주도성및실천능력)
   → ③ 공동체역량(성실성및협업태도) → ④ 학업역량(학업태도) → ⑤ 학업역량(학업성취도)

■ 2027학년도 주요 변경사항
   고교추천전형 지원자격: 2024년 2월 이후 졸업(예정)자로 강화 (재수·삼수 사실상 불가)
   데이터과학전공 신설: 빅데이터융합전공·스마트생산전공 통폐합
   기회균형전형 예체능 확대: 스포츠건강관리전공·조형예술전공 신규 추가
   논술전형 소폭 감소: 101명 → 98명
`,
      competencies: {
        academic: "학업역량(학업성취도 15%+학업태도 20%) — 서류평가 총 35%",
        career: "진로역량(진로탐색활동과경험 25%+자기주도성및실천능력 20%) — 서류평가 총 45%",
        community: "공동체역량(성실성및협업태도) — 서류 20% | 면접형(스포츠·조형): 학업20%·진로50%·공동체30%"
      },
      weights: { academic: 0.35, career: 0.45, community: 0.20 }
    },
    "\uac00\ud1a8\ub9ad\ub300\ud559\uad50": {
      factors: `
[가톨릭대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 2027학년도 학생부종합 전형 구성
   잠재능력우수자서류전형 251명: 서류100% 일괄합산 (수능최저 없음)
   잠재능력우수자면접전형 277명: 1단계(4배수) 서류100% → 2단계 1단계70%+면접30% (수능최저 없음)
   가톨릭지도자추천전형 51명: 1단계(4배수) 서류100% → 2단계 1단계70%+면접30% (가톨릭 신자 대상)
   학교장추천전형 50명: 1단계(4배수) 서류100% → 2단계 1단계70%+면접30% (약학과·의예과 수능최저 적용)
   기회균형I전형 96명: 서류100% 일괄합산
   ※ 면접전형(잠재능력우수자면접·가톨릭지도자·학교장추천·장애인대상자): 블라인드 면접, 10분 내외

■ 서류종합평가 항목 및 반영비율
   학업역량 40% — 학업성취도·학업태도·탐구력
   진로역량 35% — 전공(계열) 관련 교과 이수 노력·교과 성취도·진로 탐색 활동과 경험
   공동체역량 25% — 협업과 소통능력·나눔과 배려·성실성과 규칙준수·리더십

■ 서류종합평가 세부 평가 관점
   학업역량 — 전체 교과 성취 수준 및 성적 추이
              교과 지식 획득을 위한 자기주도적 학습의지
              수업내용을 이해하려는 태도와 열정
              탐구활동을 통한 지식확장 노력 및 성과
   진로역량 — 전공(계열) 관련 과목 선택·이수 정도 및 추가 이수 노력
              전공(계열) 관련 교과 성취 수준 및 성적 추이
              진로 관련 교과/비교과 활동 및 진로탐색 역량
   공동체역량 — 구성원 간 의사소통능력 및 협력 경험
               나눔을 통한 공동체 기여 정도
               규칙 및 기본 의무 준수 정도
               학교 활동 속에 나타난 주도적 태도와 경험

■ 면접평가 항목 (잠재능력우수자면접·가톨릭지도자추천·학교장추천·장애인대상자 2단계)
   학업역량 30% — 학업태도, 탐구력
   진로역량 50% — 전공(계열) 관련 교과이수 노력, 전공에 대한 관심과 이해, 진로 탐색 활동
   공동체역량 20% — 협업 및 의사소통능력, 나눔과 배려, 리더십 역량 및 공동체적 가치관
   ※ 서류기반 개별면접 | 평가위원 2인 이상·지원자 1인 | 10분 내외 | 블라인드

■ 동점자 처리기준 (서류전형 일괄합산)
   ① 학업역량 우수자 → ② 진로역량 우수자 → ③ 공동체역량 우수자
   (면접전형 2단계: 면접 진로역량 → 면접 학업역량 → 면접 공동체역량 → 서류총점 → 서류 진로→공동체역량 순)

■ 2027학년도 주요 변경사항
   서류평가 반영비율 변경: 학업역량 40%, 진로역량 35%, 공동체역량 25% (2026학년도 대비 조정)
   논술전형 전형방법 변경: 논술80%+학생부교과20% → 논술100% (수능최저 없음, 약학·의예·간호는 적용)
   지역균형·학교장추천전형 학교폭력 조치사항: 추천 불가(부적격) 처리로 강화
   지역균형전형 수능최저 강화: 자유전공·인문사회·자연공학계열 2개 영역 합 6 이내로 강화
`,
      competencies: {
        academic: "학업역량(학업성취도·학업태도·탐구력) — 서류 40% | 면접 30%",
        career: "진로역량(교과이수노력·진로탐색활동) — 서류 35% | 면접 50%",
        community: "공동체역량(협업·나눔·성실성·리더십) — 서류 25% | 면접 20%"
      },
      weights: { academic: 0.40, career: 0.35, community: 0.25 }
    },
    "\uc778\ud558\ub300\ud559\uad50": {
      factors: `
[인하대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강·가이드북 반영]

■ 2027학년도 학생부종합 전형 구성
   인하미래인재(면접형) 939명: 1단계(3.5배수, 의예과 3배수) 서류100% → 2단계 1단계70%+면접30%
   지역의사선발 6명: 인하미래인재(면접형) 의예과와 동일 방식
   인하미래인재(서류형) 261명: 서류100% 일괄합산
   고른기회 137명 / 농어촌학생 140명: 인하미래인재(서류형)과 동일
   ※ 전 전형 수능최저학력기준 미적용
   ※ 2027 신설: 지역의사선발 전형 (의예과 전용)
...
■ 서류평가 항목 및 반영비율
   ...
   [인하미래인재(서류형)]
   기초학업역량 50% = 학업능력(30%) + 학습태도(20%)
   진로탐구역량 30% = 진로관심(10%) + 탐구역량(20%)
   공동체역량   20%

■ 서류평가 세부 평가항목
   기초학업역량 — 학업능력: 전체 교과 성취 수준 및 교과별·학년별 성적 추이
                  학습태도: 능동적 수업 참여, 부족한 부분 발전 노력
   진로탐구역량 — 진로관심: 희망진로(전공) 관련 교과목 이수·성취도, 진로 연계 활동 참여
                  탐구역량: 습득 지식의 깊이를 더하는 노력, 지적 성장 과정
   공동체역량 — 출결상황·행동특성·봉사활동을 통해 드러나는 성실성·배려심·리더십·협업능력

■ 면접평가 (인하미래인재(면접형) 2단계)
   평가항목: 기초학업역량, 진로탐구역량, 의사소통역량
   방식: 면접위원 2인·지원자 1인, 8~10분 내외 개별 블라인드 면접
   의예과: 2개 면접실 이동 방식 (제1면접실 기초학업역량, 제2면접실 진로탐구역량+의사소통역량)

■ 2027학년도 주요 변경사항
   지역의사선발 전형 신설: 인하미래인재(면접형) 의예과와 동일 방식, 6명 선발
   지역균형 지원자격 강화: 2025년 이후 졸업자, 5학기 이상 이수자로 변경
   모집단위 광역화 확대: 프런티어창의대학 융합학부 체계 유지 (전공 자율선택)
   전기전자공학부 심화트랙 자율선택 가능
`,
      competencies: {
        academic: "기초학업역량(학업능력+학습태도) — 면접형 서류 30% / 서류형 서류 50%",
        career: "진로탐구역량(진로관심+탐구역량) — 면접형 서류 50% / 서류형 서류 30%",
        community: "공동체역량(성실·배려·리더십·협업) — 면접형·서류형 공통 20%"
      },
      weights: { academic: 0.30, career: 0.50, community: 0.20 }
    },
    "\uc544\uc8fc\ub300\ud559\uad50": {
      factors: `
[아주대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 2027학년도 학생부종합 전형 구성
   ACE전형 519명: 1단계(3배수) 서류100% → 2단계 1단계70%+면접30% (수능최저 없음, 의학과·약학과 제외)
     의학과·약학과: 수능최저 충족자 대상 3배수 선발
   첨단융합인재전형 244명: 1단계(3배수) 서류100% → 2단계 1단계70%+면접30% (수능최저 없음)
   지역의사선발전형 6명 (2027 신설): 1단계(3배수) 서류100% → 2단계 1단계70%+면접30%
   고른기회1전형 94명: 서류100% 일괄합산
   고른기회2전형 58명 / 특수교육대상자전형 10명
   국방IT우수인재1전형 23명: 1단계 서류100%(3배수) → 2단계 1단계70%+면접30% + 신체검사·체력검정·신원조회(P/F)

■ 서류평가 항목 및 반영비율 (ACE전형 기준)
   학업역량 37% — 고교 교육과정 기반 학업수행능력, 학업 탐구활동과 지적 호기심
   진로역량 35% — 진로탐색(교과 선택·이수·교내활동), 진로참여(도전·시도·노력), 진로성장(변화·성취)
   공동체역량 28% — 공동체 기여와 협력의 행동, 학교생활 책임감과 성실성

■ 면접평가 항목 (2단계, 의학과 제외)
   서류 신뢰도(학업역량·진로역량·공동체역량) 80% — 서류 진위확인, 교내 활동과정·노력·성취
   의사소통능력·태도 20% — 질문 이해 및 논리적 답변, 면접 태도
   방식: 면접관 2인 이상·지원자 1인, 10분 내외, 블라인드 개별면접

■ 면접평가 항목 (의학과)
   서류 신뢰도(학업역량·진로역량) 40% — 학업·전공연계성·도전성·자기주도학습
   제시문 활용 면접(공동체역량) 60% — 리더십·갈등관리·협력·봉사·정직성·생명윤리
   방식: 2개 면접실, 20분 내외 (서류기반면접 10분 + 제시문면접 10분)

■ 2027학년도 주요 변경사항
   지역의사선발전형 신설: 진료권별 해당 지역 재학·거주 지원자격, 수능최저 적용
   고른기회2전형 지원자격 확대
   모집단위 개편: 산업공학과→첨단스마트산업공학과, 응용화학과+환경안전공학과→첨단에코에너지공학과, 소프트웨어학과→AI컴퓨터공학부
   학생부교과 수능 전 영역 응시 지원자격 요건 폐지
`,
      competencies: {
        academic: "학업역량(학업수행능력·탐구활동·지적호기심) — 서류 37%",
        career: "진로역량(진로탐색·진로참여·진로성장) — 서류 35%",
        community: "공동체역량(기여·협력·책임감·성실성) — 서류 28%"
      },
      weights: { academic: 0.37, career: 0.35, community: 0.28 }
    },
    "\uc778\ucc9c\ub300\ud559\uad50": {
      factors: `
[인천대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강·가이드북 반영]

■ 2027학년도 학생부종합 전형 구성
   자기추천전형 694명: 1단계(3배수, 사범대·스포츠의학부 4배수) 서류100% → 2단계 1단계70%+면접30% (수능최저 없음)
   기회균형전형 110명: 서류100% 일괄합산
   서해5도출신자전형 6명 / 특수교육대상자전형 48명 (정원외)

■ 서류평가 항목 및 반영비율 (전 전형 공통)
   학업역량 30% — 교과 기초학업역량, 학업 발전 정도, 학습 의지와 노력, 탐구·문제해결 노력
   진로역량 30% — 전공(계열) 필요 과목 선택·이수·성취 수준, 진로 탐색 과정의 활동·경험·노력
   발전역량 20% — 창의적·대안적 문제해결 능력, 진취적 도전 및 해결 노력, 자기주도 학업 노력
   공동체역량 20% — 협력·의사소통 능력, 배려와 나눔의 태도, 책임감·윤리·원칙 준수

■ 면접평가 항목 (자기추천전형·특수교육대상자전형 2단계)
   평가요소: 진로역량, 발전역량, 공동체역량, 의사소통능력
   방식: 면접위원 2인·지원자 1인 개별면접, 10분 내외
   ※ 학업역량은 면접 평가요소에서 제외 (서류평가에서만 반영)

■ 서류평가 과정
   입학사정관 2인 1조 개인평가 → 재평가 대상 검증 → 재평가 → 합격자 선발 (블라인드 평가)

■ 2027학년도 주요 변경사항
   단과대학·모집단위 명칭 변경:
     인공지능대학: 정보통신공학과→인공지능정보통신공학부, 임베디드시스템공학과→인공지능시스템공학과
     예술체육대학: 운동건강학부→스포츠의학부
   교과성적우수자전형 수능최저 완화: 최소 2개 영역 응시(한국사 제외)로 변경 (기존: 수능 4개 영역 전부 응시)
   실기우수자(스포츠과학부) 전형방법 변경: 1단계+2단계 → 일괄합산(학생부40%+실기60%)
`,
      competencies: {
        academic: "학업역량(기초학업역량·발전정도·탐구노력) — 30%",
        career: "진로역량(전공과목선택이수·진로탐색활동) + 발전역량(창의적문제해결·도전노력) — 30%+20%",
        community: "공동체역량(협력·소통·배려·책임감) — 20%"
      },
      weights: { academic: 0.30, career: 0.50, community: 0.20 }
    },
    "\uc11c\uc6b8\uacfc\ud559\uae30\uc220\ub300\ud559\uad50": {
      factors: `
[서울과학기술대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 2027학년도 학생부종합 전형 구성
   학교생활우수자전형 496명: 1단계(3배수) 서류100% → 2단계 1단계70%+면접30% (수능최저 없음)
   창의융합인재전형 91명: 1단계(3배수) 서류100% → 2단계 1단계70%+면접30% (수능최저 없음)
     대상: 에너지바이오대학(바이오메디컬·양자융합물리), 창의융합대학(인공지능응용·지능형반도체·미래에너지), 자유전공학부(창의융합대학)
   기회균형전형 253명(국가보훈대상자19+기회균등86+농어촌68+평생학습자72+특수교육10)

■ 서류평가 항목 및 반영비율 (학교생활우수자·창의융합인재 공통)
   학업역량 35% — 교과 학습 성취 수준, 학업 의지와 노력, 지적 탐구 활동
   진로역량 45% — 전공(계열) 관련 교과 이수 및 성취, 진로 탐색과 도전의 노력과 성장
   공동체역량 20% — 공동체 기여와 협력, 책임감·배려·나눔의 태도

■ 면접평가 항목 (2단계)
   학업역량 35% / 진로역량 40% / 공동체역량 25%
   방식: 제출서류 기반 정성평가, 블라인드 면접 (교복 착용 금지)

■ 동점자 처리기준 (학교생활우수자·창의융합인재)
   1단계: 공동체역량 우수자 → 학업역량 우수자 → 한국사 원점수 상위자
   2단계: 서류총점 우수자 → 공동체역량 우수자 → 학업역량 우수자 → 한국사 원점수 상위자

■ 2027학년도 주요 변경사항
   학과 신설: 양자융합물리학과 (에너지바이오대학, 양자컴퓨터·차세대반도체 등 첨단분야 대응)
   학과 명칭 변경: 스마트ICT융합공학과→ICT융합공학과, 디자인학과(산업/시각)→산업·시각디자인학과
     산업공학과→산업공학부, 미래에너지융합학과→미래에너지학과
   자유전공학부 분리: ST자유전공학부 → ST자유전공학부_자연 / ST자유전공학부_인문으로 분리
   수시 69.5%(1,747명) / 정시 30.5%(768명) 선발
`,
      competencies: {
        academic: "학업역량(교과성취·학업의지·탐구활동) — 서류 35% / 면접 35%",
        career: "진로역량(전공관련교과이수·진로탐색·도전·성장) — 서류 45% / 면접 40%",
        community: "공동체역량(기여·협력·책임감·배려) — 서류 20% / 면접 25%"
      },
      weights: { academic: 0.35, career: 0.45, community: 0.20 }
    },
    "\ubd80\uc0b0\ub300\ud559\uad50": {
      factors: `
[부산대학교 2027학년도 수시 학생부종합전형 서류평가 기준 — 모집요강 반영]

■ 2027학년도 학생부종합전형 구성
   학생부종합전형 778명 / 지역인재전형 173명 / 지역의사선발전형 31명
   기타(지역인재저소득층·사회배려자·저소득층·특성화고·특수교육) 다수
   전형방법: 1단계(3~4배수) 서류100% → 2단계 1단계80%+면접20%
   수능최저: 간호학과·약학부·의예과·치의예과에만 적용

■ 서류평가 항목 및 반영비율 (평가요소별 평가기준)
   학업역량 40%
     - 학업준비도: 이수 교과의 학업성취도(국어·수학·영어·사회·과학·한국사)
     - 학업주도성: 교과 선택 및 이수 노력, 학업 태도 및 탐구 능력
   탐구역량 40%
     - 자기주도성: 관심 분야 관련 교과 이수 노력 및 학업성취도, 학업태도 및 탐구 능력
     - 성장가능성: 자기계발 노력(창의적 체험활동상황: 자율·동아리·진로활동)
   사회역량 20%
     - 사회성 및 인성: 협업 능력과 리더십, 의사소통능력, 공동체의식, 성실성과 규칙 준수

■ 면접평가 항목 (2단계, 학생부 기반 면접 10분)
   탐구역량: 관심 분야 교과 이수 노력, 학업태도 및 탐구 능력, 자기계발 노력
   사회역량: 협업능력·리더십, 의사소통능력, 공동체의식, 성실성과 규칙준수
   (의예과 추가) 잠재역량: 종합적 사고력, 지식활용능력, 논리적 의사표현능력 (별도 공통문제 10분)

■ 인재상
   충실한 학교생활을 바탕으로 학업역량을 갖추며, 관심 분야에 대해 주도적으로 탐구하는 열정을 지닌 학생

■ 2027학년도 주요 변경사항
   학사구조 개편: 데이터사이언스학부 신설(AI대학), X-모빌리티융합학부 신설(공과대학)
   바이오메디컬공학과 신설(공과대학, 양산캠퍼스)
   스마트가전공학과 신설(공과대학, LG전자 채용조건형 계약학과)
   지역의사선발전형 신설(의과대학 의예과 31명)
   캠퍼스: 부산(본캠), 밀양(생명자원과학대학), 양산(의·치·한·간호·바이오메디컬·응용생명융합·데이터사이언스)
`,
      competencies: {
        academic: "학업역량(학업준비도·학업주도성) — 서류 40%",
        career: "탐구역량(자기주도성·성장가능성, 관심분야 교과이수·탐구·자기계발) — 서류 40%",
        community: "사회역량(협업·리더십·의사소통·공동체의식·성실성) — 서류 20%"
      },
      weights: { academic: 0.40, career: 0.40, community: 0.20 }
    },
    ...
    "\uacbd\ubd81\ub300\ud559\uad50": {
      factors: [
        { name: "학업역량", weight: 30, details: "자기주도적 학업 노력(30%)" },
        { name: "진로역량", weight: 50, details: "전공관련교과 이수 정도(15%) + 진로탐색활동 및 노력(35%)" },
        { name: "공동체역량", weight: 20, details: "바람직한 공동체 의식과 실천(20%)" }
      ],
      competencies: {
        academic: "자기주도적 학업 노력",
        career: "전공관련교과 이수 정도, 진로탐색활동 및 노력",
        community: "바람직한 공동체 의식과 실천"
      },
      weights: { academic: 0.30, career: 0.50, community: 0.20 }
    },
    ...
    "\uc804\ubd81\ub300\ud559\uad50": {
      factors: [
        { name: "학업역량", weight: 40, details: "학업성취도, 학업태도, 탐구력 등(40%)" },
        { name: "진로역량", weight: 40, details: "전공 관련 교과 이수 노력, 진로탐색 활동 및 경험(40%)" },
        { name: "공동체역량", weight: 20, details: "공동체 의식, 협업 능력, 나눔과 배려, 소통 능력(20%)" }
      ],
      competencies: {
        academic: "학업성취도, 학업태도, 탐구력",
        career: "전공 관련 교과 이수 노력, 진로탐색 활동 및 경험",
        community: "공동체 의식, 협업 능력, 나눔과 배려, 소통 능력"
      },
      weights: { academic: 0.40, career: 0.40, community: 0.20 }
    },
    ...
    "\uc804\ub0a8\ub300\ud559\uad50": {
      factors: [
        { name: "진로역량", weight: 40, details: "전공 관련 교과 이수 노력, 진로탐색 활동 및 경험(40%)" },
        { name: "학업역량", weight: 30, details: "학업성취도, 학업태도와 학업의지, 탐구력(30%)" },
        { name: "공동체역량", weight: 30, details: "협업과 소통능력, 나눔과 배려, 성실성(30%)" }
      ],
      competencies: {
        academic: "학업성취도, 학업태도와 학업의지, 탐구력",
        career: "전공 관련 교과 이수 노력, 진로탐색 활동 및 경험",
        community: "협업과 소통능력, 나눔과 배려, 성실성"
      },
      weights: { academic: 0.30, career: 0.40, community: 0.30 }
    },
    ...
    "\ucda9\ubd81\ub300\ud559\uad50": {
      factors: [
        ...
        { name: "진로역량", weight: 40, details: "전공관련 교과 이수 노력, 진로탐색 활동 및 경험(40%)" },
        { name: "공동체역량", weight: 20, details: "협업과 소통능력, 나눔과 배려, 성실성(20%)" }
      ],
      competencies: {
        academic: "학업성취도, 학업태도와 학업의지, 탐구력",
        career: "전공관련 교과 이수 노력, 진로탐색 활동 및 경험",
        community: "협업과 소통능력, 나눔과 배려, 성실성"
      },
      weights: { academic: 0.40, career: 0.40, community: 0.20 }
    },
    ...
    "\ucda9\ub0a8\ub300\ud559\uad50": {
      factors: [
        { name: "학업역량", weight: 40, details: "학업성취도, 학업태도와 학업의지, 탐구력(40%)" },
        { name: "진로역량", weight: 30, details: "전공 관련 교과 이수 노력, 진로탐색 활동 및 경험(30%)" },
        { name: "공동체역량", weight: 30, details: "협업과 소통능력, 나눔과 배려, 성실성과 규칙 준수, 리더십(30%)" }
      ],
      competencies: {
        academic: "학업성취도, 학업태도와 학업의지, 탐구력",
        career: "전공 관련 교과 이수 노력, 진로탐색 활동 및 경험",
        community: "협업과 소통능력, 나눔과 배려, 성실성과 규칙 준수, 리더십"
      },
      weights: { academic: 0.40, career: 0.30, community: 0.30 }
    },
    ...
    "\ud55c\uc591\ub300\ud559\uad50 ERICA": {
      factors: [
        { name: "학업역량", weight: 40, details: "학업성취도, 학업태도와 학업의지, 탐구력(40%)" },
        { name: "진로역량", weight: 40, details: "전공 관련 교과 이수 노력, 진로탐색 활동 및 경험(40%)" },
        { name: "공동체역량", weight: 20, details: "협업과 소통능력, 나눔과 배려, 성실성과 규칙 준수, 리더십(20%)" }
      ],
      competencies: {
        academic: "학업성취도, 학업태도와 학업의지, 탐구력",
        career: "전공 관련 교과 이수 노력, 진로탐색 활동 및 경험",
    ...
    "\uace0\ub824\ub300\ud559\uad50(\uc138\uc885)": {
      factors: [
        { name: "학업역량", weight: 30, details: "학업성취도, 학업태도와 학업의지, 탐구력(30%)" },
        { name: "진로역량", weight: 50, details: "전공 관련 교과 이수 노력, 전공 관련 발전 가능성, 진로탐색 활동 및 경험(50%)" },
        { name: "공동체역량", weight: 20, details: "협업과 소통능력, 나눔과 배려, 성실성과 규칙 준수(20%)" }
      ],
      competencies: {
        academic: "학업성취도, 학업태도와 학업의지, 탐구력",
        career: "전공 관련 교과 이수 노력, 전공 관련 발전 가능성, 진로탐색 활동 및 경험",
...
`;
  ...
  function renderTopStudentsTable() {
    ...
    topStudents.forEach((s, i) => {
      ...
      const gradeTag = (domain) => { const g = s[domain]?.grade ?? s[domain]?.등급; return (g !== undefined && g !== null && g !== '') ? ` · ${g}등급` : ''; };
      topHtml += `<tr>
        <td style="${td}">${i + 1}</td>
        ...
        <td style="${td}${colActive('국어')}">${s['국어']?.raw ?? s['국어']?.원점수 ?? '-'}<br><small style="color:var(--text-secondary);">${s['국어']?.subjectName || ''}${gradeTag('국어')}</small></td>
        <td style="${td}${colActive('수학')}">${s['수학']?.raw ?? s['수학']?.원점수 ?? '-'}<br><small style="color:var(--text-secondary);">${s['수학']?.subjectName || ''}${gradeTag('수학')}</small></td>
        <td style="${td}${colActive('영어')}">${s['영어']?.raw ?? s['영어']?.원점수 ?? '-'}<br><small style="color:var(--text-secondary);">${s['영어']?.grade ?? s['영어']?.등급 ?? '-'}등급</small></td>
        <td style="${td}${colActive('탐구1')}">${s['탐구영역1']?.raw ?? s['탐구영역1']?.원점수 ?? '-'}<br><small style="color:var(--text-secondary);">${s['탐구영역1']?.subjectName || ''}${gradeTag('탐구영역1')}</small></td>
        <td style="${td}${colActive('탐구2')}">${s['탐구영역2']?.raw ?? s['탐구영역2']?.원점수 ?? '-'}<br><small style="color:var(--text-secondary);">${s['탐구영역2']?.subjectName || ''}${gradeTag('탐구영역2')}</small></td>
...
<body>
  ...
  function renderSchoolMockChoices(studentScores) {
    ...
    const _mockGrade = document.getElementById('schoolMockGrade')?.value;
    if (_mockGrade !== '1' && _mockGrade !== '2') {
      ...
      [schoolMockKorChoiceChart, schoolMockMathChoiceChart, schoolMockSocialChoiceChart, schoolMockScienceChoiceChart].forEach(ch => { if (ch) { ch.destroy(); } });
      schoolMockKorChoiceChart = null; schoolMockMathChoiceChart = null; schoolMockSocialChoiceChart = null; schoolMockScienceChoiceChart = null;
    }
